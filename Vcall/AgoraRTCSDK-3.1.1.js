...
!function(e, t) {
    ...
    return function(e) {
        ...
        setInterval((function() {
            Object(s.getParameter)("UPLOAD_LOG") && g.info("console log upload")
        }
        ), 9e5);
        var g = function() {
            var e, t, n, i, g, m, v = "https://".concat(Object(s.getParameter)("LOG_UPLOAD_SERVER"), "/upload/v1"), S = ["DEBUG", "INFO", "WARNING", "ERROR", "NONE"], _ = 0, h = function e(t) {
                u = "uploading",
                setTimeout((function() {
                    !function(e, t, n) {
                        var i;
                        ...
                        i = {
                            ...
                            process_id: Object(c.a)(),
                            payload: JSON.stringify(e)
                        };
                        try {
                            Object(o.post)(v, i, (function(e) {
                                "OK" === e ? t && t(e) : n && n(e)
                            }
                            ), (function(e) {
                                n && n(e)
                        ...
                        f = 0,
                        0 !== l.length ? (p = l.length < 10 ? l.splice(0, l.length) : l.splice(0, 10),
                        e(p)) : u = "free"
                    }
                    ), (function() {
                        setTimeout((function() {
                ...
                if (Object(s.getParameter)("UPLOAD_LOG"))
                    try {
                        ...
                        "free" === u && (p = l.length < 10 ? l.splice(0, l.length) : l.splice(0, 10),
                        h(p))
                    } catch (e) {}
            };
            t = function() {
            ...
            ,
            {
                ...
                enableLogUpload: function() {
                    Object(s.setParameter)("UPLOAD_LOG", !0)
                },
                disableLogUpload: function() {
                    Object(s.setParameter)("UPLOAD_LOG", !1)
                },
                setProxyServer: function(e) {
                    v = e ? "https://".concat(e, "/ls/?h=").concat(Object(s.getParameter)("LOG_UPLOAD_SERVER"), "&p=443&d=upload/v1") : "https://".concat(Object(s.getParameter)("LOG_UPLOAD_SERVER"), "/upload/v1")
                },
                ...
                log: e = function() {
                    var e = arguments[0]
                      , t = arguments;
                    if (t[0] = r() + " Agora-SDK [" + (S[e] || "DEFAULT") + "]:",
                    E(e, t),
                    !(e < _))
                        switch (e) {
                        case 0:
    ...
    , function(e, t, n) {
        ...
        var g, m, v = {
            ...
            return S || (S = "process-" + l()(),
            c.default.info("processId: " + S)),
            S
        }, h = (m = 0,
        (g = {
            list: {},
            ...
            getUrl: function() {
                return g.proxyServerURL ? "https://".concat(g.proxyServerURL, "/rs/?h=").concat(Object(s.getParameter)("EVENT_REPORT_DOMAIN"), "&p=6443&d=events/message") : "https://".concat(Object(s.getParameter)("EVENT_REPORT_DOMAIN"), ":6443/events/message")
            },
            getBackUrl: function() {
                return g.proxyServerURL ? "https://".concat(g.proxyServerURL, "/rs/?h=").concat(Object(s.getParameter)("EVENT_REPORT_BACKUP_DOMAIN"), "&p=6443&d=events/message") : "https://".concat(Object(s.getParameter)("EVENT_REPORT_BACKUP_DOMAIN"), ":6443/events/message")
            },
            getSessionStartTime: function(e) {
                return g.list[e].startTime
            },
            sessionInit: function(e, t) {
                ...
                g._flushInvokeReport(e)
            },
            joinChooseServer: function(e, t, n) {
                if (g.list[e]) {
                    t.uid && (g.list[e].uid = parseInt(t.uid)),
                    t.cid && (g.list[e].cid = parseInt(t.cid));
                    var i = o()({}, g.list[e]);
            ...
            publish: function(e, t) {
                ...
                n.success = t.succ,
                n.errorCode = t.ec,
                n.publishRequestid = t.publishRequestid,
                n.p2pid = t.p2pid,
            ...
            subscribe: function(e, t) {
                ...
                n.errorCode = t.ec,
                n.success = t.succ,
                n.subscribeRequestid = t.subscribeRequestid,
                n.p2pid = t.p2pid,
            ...
            firstVideoReceived: function(e, t) {
                ...
                n.uid = t.uid,
                n.elapse = t.elapse,
                n.subscribeElapse = t.subscribeElapse,
                n.subscribeRequestid = t.subscribeRequestid,
                n.p2pid = t.p2pid,
                g.send({
            ...
            sendCustomReportMessage: function(e, t, n) {
                var i = {
                    type: "io.agora.pb.Wrtc.UserAnalytics",
                    data: f({
                        sid: e
                    }, t)
                }
                  , a = g.getUrl();
                Object(d.post)(a, i, (function(e) {
                    n && n()
                }
                ), (function(e) {
                    var t = g.getBackUrl();
                    Object(d.post)(t, i, (function(e) {
                        n && n()
                    }
                    ), (function(e) {
                        n && n("Failed")
            ...
            joinChannelTimeOut: function(e) {
                g.send({
                    type: "io.agora.pb.Wrtc.JoinChannelTimeout",
                    data: f({}, e)
                })
            },
            peerPublishStatus: function(e) {
                g.send({
                    type: "io.agora.pb.Wrtc.PeerPublishStatus",
                    data: f({}, e)
                })
            }
        ...
        ,
        g._cachedItems = [],
        g._cacheInvokeReport = function(e) {
            e.lts || (e.lts = Date.now()),
            g._cachedItems.push(e),
            g._cachedItems.length > 50 && g._cachedItems.shift()
        }
        ,
        g._flushInvokeReport = function(e) {
            if (g._cachedItems.length) {
                var t = g._cachedItems;
                g._cachedItems = [],
        ...
        g._sendApiInvoke = function(e) {
            ...
            if (!(t && m instanceof Array && -1 !== m.indexOf(t)))
                if (g.list[i]) {
                    ...
                    g._cacheInvokeReport(arguments[0])
        }
        ,
        g._send = function(e) {
            try {
                ...
                var n = t.map((function(e) {
                  ...
                  , i = g.getUrl();
                i = -1 === g.getUrl().indexOf("?") ? "".concat(i, "?").concat(n) : i,
        ...
        g.send = function(e) {
            if (e.data) {
                var t = e.data;
                g._lastLts && g._lastLts >= t.lts && (t.lts = g._lastLts + 1),
                g._lastLts = t.lts
            }
            if (g.sendCache.push(e),
            null === g.sendTimer)
                return function e() {
                    g.sendTimer = setTimeout((function() {
                        if (0 !== g.sendCache.length)
                            return g._send(g.sendCache.shift()),
                            e();
                        g.sendTimer = null
                    }
    ...
    , function(e, t, n) {
        ...
        t.SUPPORT_RESOLUTION_LIST = {
            ...
            "720p_1": [1280, 720, 15, 15, 900, 1130, 1, 5],
            "720p_2": [1280, 720, 15, 15, 930, 1800, 25, 30],
    ...
    , function(e, t, n) {
        ...
        var c = s(n(32))
          ...
          , g = function(e) {
            function t(t, n) {
                ...
                return i._state = h.RELAY_STATE_IDLE,
                i._onStatus = function(e) {
                    u.default.debug("[" + i.clientId + "] ChannelMediaStatus: " + JSON.stringify(e)),
                    e && e.command && ("onAudioPacketReceived" === e.command && i.emit("event", _.PACKET_RECEIVED_AUDIO_FROM_SRC),
                    "onVideoPacketReceived" === e.command && i.emit("event", _.PACKET_RECEIVED_VIDEO_FROM_SRC),
                    "onSrcTokenPrivilegeDidExpire" === e.command && (i._state = h.RELAY_STATE_FAILURE,
                    i.emit("state", h.RELAY_STATE_FAILURE, E.SRC_TOKEN_EXPIRED)),
                    "onDestTokenPrivilegeDidExpire" === e.command && (i._state = h.RELAY_STATE_FAILURE,
                    i.emit("state", h.RELAY_STATE_FAILURE, E.DEST_TOKEN_EXPIRED, e.channelName ? {
                        came: e.channelName
                    } : null)))
                }
                ,
                    ...
                    return r(i, void 0, void 0, (function() {
                        ...
                        return o(this, (function(t) {
                            ...
                            case 0:
                                ...
                                this.emit("event", _.NETWORK_DISCONNECTED),
                                this.state = h.RELAY_STATE_IDLE,
                            ...
                            case 2:
                                ...
                                [3, 4];
                            case 3:
                                return (e = t.sent())instanceof T && (e.message === v.WS_ABORT || e.message === v.AP_REQUEST_ABORT) ? [2] : (this.emit("state", h.RELAY_STATE_FAILURE, E.SERVER_CONNECTION_LOST),
                                [3, 4]);
                            case 4:
                                return [2]
                            }
            ...
            t.prototype.startChannelMediaRelay = function(e) {
                return r(this, void 0, void 0, (function() {
                    return o(this, (function(t) {
                        switch (t.label) {
                        case 0:
                            if (this.state !== h.RELAY_STATE_IDLE)
                                throw new T(v.BAD_STATE);
                            return this.state = h.RELAY_STATE_CONNECTING,
                            [4, this._connect()];
                        case 1:
                            return t.sent(),
            ...
            t.prototype.updateChannelMediaRelay = function(e) {
                return r(this, void 0, void 0, (function() {
                    return o(this, (function(t) {
                        switch (t.label) {
                        case 0:
                            if (this.state !== h.RELAY_STATE_RUNNING)
                                throw new T(v.BAD_STATE);
                ...
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(t) {
                        ...
                        case 2:
                            ...
                            this.emit("event", _.NETWORK_CONNECTED),
                            [2]
                        }
                    }
                    ))
            ...
            t.prototype._sendStartRelayMessage = function(e) {
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(o) {
                        ...
                        case 5:
                            return o.sent(),
                            this.emit("event", _.PACKET_JOINED_SRC_CHANNEL),
                        ...
                        case 8:
                            return o.sent(),
                            this.emit("event", _.PACKET_JOINED_DEST_CHANNEL),
                        ...
                        case 9:
                            return o.sent(),
                            this.emit("event", _.PACKET_SENT_TO_DEST_CHANNEL),
                            this.state = h.RELAY_STATE_RUNNING,
            ...
            t.prototype._sendUpdateMessage = function(e) {
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(n) {
                        ...
                        case 1:
                            return n.sent(),
                            this.emit("event", _.PACKET_UPDATE_DEST_CHANNEL),
        ...
        }(_ = t.CHANNEL_MEDIA_RELAY_EVENT || (t.CHANNEL_MEDIA_RELAY_EVENT = {})),
        function(e) {
        ...
        }(h = t.CHANNEL_MEDIA_RELAY_STATE || (t.CHANNEL_MEDIA_RELAY_STATE = {})),
        function(e) {
    ...
    , function(e, t, n) {
        ...
        var v = function(e, t, n) {
            try {
                ...
                var i = document.createElement("video");//ini
          ...
          , _ = function(e) {
            ...
            for (var n in e)
                if ("lowLatency" === n && "boolean" != typeof e[n] || "userConfigExtraInfo" === n && "object" !== a()(e[n]) || "transcodingUsers" === n && !h(e[n]) || !~t.indexOf(n) && "number" != typeof e[n])
    ...
    , function(e, t, n) {
        ...
        "undefined" != typeof window && window.navigator)
            if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
                for (var _ in S.log("This appears to be Firefox"),
                d = "firefox",
                ...
                for (var _ in S.log("This appears to be Chrome"),
                d = "chrome",
        ...
        p ? y = p : "undefined" != typeof window && (y = window.RTCPeerConnection)
    }
    , function(e, t, n) {
        "use strict";
        n.d(t, "a", (function() {
    ...
    , function(e, t, n) {
        ...
        r = function() {
            ...
            function i(e, t, i, a) {
                var r = a || n
                  , o = e.createShader(i);
                return e.shaderSource(o, t),
                e.compileShader(o),
                e.getShaderParameter(o, e.COMPILE_STATUS) ? o : (r("*** Error compiling shader '" + o + "':" + e.getShaderInfoLog(o)),
                e.deleteShader(o),
                null)
            }
            function a(e, t, i, a, r) {
                ...
                e.linkProgram(s),
                e.getProgramParameter(s, e.LINK_STATUS) ? s : (o("Error in program linking:" + e.getProgramInfoLog(s)),
                e.deleteProgram(s),
                null)
            }
            ...
            return i(void 0, void 0, void 0, (function() {
                ...
                return a(this, (function(a) {
                    ...
                    case 0:
                        ...
                        "undefined" != typeof window ? [3, 1] : ("NOT_BROWSER_ENV",
                        c.default.error("getSupportedCodec: NOT_BROWSER_ENV"),
                    ...
                    case 1:
                        try {
                            ...
                            return c.default.error("Failed to init RTCPeerConnection", e),
                            [2, Promise.reject(e)]
                        }
                        return n ? [3, 2] : (c.default.warning("getSupportedCodec: no RTCPeerConnection constructor is detected"),
                        [2, Promise.resolve(t)]);
                    case 2:
                        ...
                        r = void 0,
                        (s.isSafari() || s.isFireFox() || s.isWeChatBrowser()) && n.addTransceiver ? (n.addTransceiver("audio"),
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            var f = o.audioTimerLoop((function() {
                return function() {
                    if (u.paused && u.play(),
    ...
    , function(e, t, n) {
        var i = function(e) {
            ...
            return l.prototype = v.constructor = p,
            p.constructor = l,
    ...
    , function(t, n, a) {
        ...
        var v = new function() {
          ...
          , y = function(e) {
            ...
            e.stream.video ? t.div.setAttribute("style", "width: 100%; height: 100%; position: relative; background-color: black; overflow: hidden;") : t.div.setAttribute("style", "width: 100%; height: 100%; position: relative; overflow: hidden;"), //ini
                ...
                u) {
                    ...
                    a[u].playDeferTimeout = setTimeout((function() {
                        ...
                        if (p === f) {
                            ...
                            o.default.debug("[".concat(t.id, "] Status Change after event Triggered.") + "Stream ".concat(t.id, " PlayerId ").concat(t.playerId, " mediaType ").concat(u, " Status ").concat(p, "=>").concat(f))
                    }
                ...
                y && y.catch && y.catch((function(n) {
                    if (!t.destroyed && l) {
                        ...
                        if (r.status !== u.status) {
                            ...
                            o.default.debug("[".concat(t.id, "] Media Player Status Change"), f),
                            e.stream.dispatchEvent(f),
                            s.b.reportApiInvoke(e.stream.sid, {
                                name: "Stream.playerStatusChange",
                                options: f,
                                tag: "tracer"
        ...
        var A = function(e) {
            ...
            t.processSignalingMessage = function(e) {
                ...
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(n)).catch((function(e) {}
                ))) : "offer" === i.messageType ? t.error("Not written yet") : t.error("Illegal message for this state: " + i.messageType + " in state " + t.state) : "established" === t.state && ("OFFER" === i.messageType ? (n = {
                    sdp: i.sdp,
                    type: "offer"
                },
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(n)).catch((function(e) {}
                ...
                n.sdp = l(n.sdp),
                t.peerConnection.setRemoteDescription(new RTCSessionDescription(n)).catch((function(e) {}
                ))) : t.error("Illegal message for this state: " + i.messageType + " in state " + t.state))
            }
            ;
            var p = 0
              , f = 0;
            ...
            t._processGetStatsAfterChrome76 = function(e) {
                ...
                t.peerConnection.getStats().then((function(r) {
                    var o, u = [], l = [], p = new Map, f = new Date, g = b(r.values());
                    try {
                        for (g.s(); !(o = g.n()).done; ) {
                            var m = o.value;
                            "codec" != m.type ? "candidate-pair" != m.type ? ("inbound-rtp" === m.type && "video" === m.mediaType && p.set("inbound-video", m),
                            "inbound-rtp" === m.type && "audio" === m.mediaType && p.set("inbound-audio", m),
                            "outbound-rtp" === m.type && "audio" === m.mediaType && p.set("outbound-audio", m),
                            "outbound-rtp" === m.type && "video" === m.mediaType && p.set("outbound-video", m),
                            "track" === m.type && "video" === m.kind && m.remoteSource && p.set("remote-video-track", m),
                            "track" === m.type && "audio" === m.kind && m.remoteSource && p.set("remote-audio-track", m),
                            "remote-inbound-rtp" === m.type && "video" === m.mediaType && p.set("remote-inbound-video", m),
                            "remote-inbound-rtp" === m.type && "audio" === m.mediaType && p.set("remote-inbound-audio", m),
                            "track" !== m.type || "video" !== m.kind || m.remoteSource || p.set("local-video-track", m),
                            "track" !== m.type || "audio" !== m.kind || m.remoteSource || p.set("local-audio-track", m),
                            "media-source" === m.type && "video" === m.kind && p.set("media-source-video", m),
                            "media-source" === m.type && "audio" === m.kind && p.set("media-source-audio", m)) : l.push(m) : u.push(m)
                        }
                    } catch (e) {
                        g.e(e)
                    } finally {
                    ...
                    d.timestamp = f,
                    n.isSubscriber)
                        (v = p.get("inbound-video")) && (t._setStat(c, "id", "inbound_video_ssrc_recv"),
                        t._setStat(c, "mediaType", v.mediaType),
                        t._setStat(c, "packetsLost", v.packetsLost),
                        ...
                        t._setStat(c, "googNacksSent", v.nackCount),
                        t._setStat(c, "googPlisSent", v.pliCount),
                        t._setStat(c, "googFirsSent", v.firCount),
                        t._setStat(c, "bytesReceived", v.bytesReceived),
                        t._setStat(c, "packetsReceived", v.packetsReceived)),
                        (v = p.get("inbound-audio")) && (t._setStat(s, "id", "inbound_audio_ssrc_recv"),
                        t._setStat(s, "mediaType", v.mediaType),
                        t._setStat(s, "bytesReceived", v.bytesReceived),
                        t._setStat(s, "packetsLost", v.packetsLost),
                        t._setStat(s, "packetsReceived", v.packetsReceived),
                        t._setStat(s, "googAccelerateRate", v.removedSamplesForAcceleration),
                        t._setStat(s, "googCurrentDelayMs", v.jitterBufferDelay),
                        ...
                        t._setStat(s, "googJitterReceived", v.jitter),
                        t._setStat(s, "googPreferredJitterBufferMs", null),
                        t._setStat(s, "googSecondaryDecodedRate", null)),
                        (v = p.get("remote-video-track")) && (t._setStat(c, "googTargetDelayMs", v.jitterBufferDelay),
                        t._setStat(c, "googFrameWidthReceived", v.frameWidth),
                        t._setStat(c, "googFrameHeightReceived", v.frameHeight),
                        t._setStat(c, "googJitterBufferMs", v.jitterBufferDelay / v.jitterBufferEmittedCount * 1e3),
                        t._setStat(c, "googCurrentDelayMs", v.jitterBufferDelay),
                        t._setStat(c, "googFramesDecoded", v.framesDecoded),
                        t._setStat(c, "googFramesReceived", v.framesReceived)),
                        (v = p.get("remote-audio-track")) && (t._setStat(s, "audioOutputLevel", 32767 * v.audioLevel),
                        t._setStat(s, "googJitterBufferMs", v.jitterBufferDelay / v.jitterBufferEmittedCount * 1e3),
                        t._setStat(s, "googExpandRate", v.concealedSamples),
                        t._setStat(s, "googPreemptiveExpandRate", v.insertedSamplesForDeceleration),
                        t._setStat(s, "googSpeechExpandRate", v.silentConcealedSamples));
                    else {
                        var h = t.lastStats.get("timestamp")
                          , E = t.lastStats.get("outbound-video");
                        if ((v = p.get("outbound-audio")) && (t._setStat(i, "id", "outbound_audio_ssrc_send"),
                        t._setStat(i, "mediaType", v.mediaType),
                        t._setStat(i, "aecDivergentFilterFraction", null),
                        t._setStat(i, "bytesSent", v.bytesSent),
                        t._setStat(i, "packetsSent", v.packetsSent),
                        S = v.transportId),
                        v = p.get("outbound-video")) {
                            if (t._setStat(a, "id", "outbound_video_ssrc_send"),
                            t._setStat(a, "mediaType", v.mediaType),
                            t._setStat(a, "bytesSent", v.bytesSent),
                            t._setStat(a, "packetsSent", v.packetsSent),
                            t._setStat(a, "googAdaptationChanges", v.qualityLimitationDurations),
                            t._setStat(a, "googAvgEncodeMs", null),
                            t._setStat(a, "googEncodeUsagePercent", null),
                            S = v.transportId,
                            v.totalEncodedBytesTarget && E && E.totalEncodedBytesTarget) {
                                var I = (v.totalEncodedBytesTarget - E.totalEncodedBytesTarget) / (+new Date - h);
                                t._setStat(d, "googTargetEncBitrate", Math.floor(8 * I * 1e3))
                            }
                            if (v.retransmittedBytesSent && E && E.retransmittedBytesSent) {
                                var T = (v.retransmittedBytesSent - E.retransmittedBytesSent) / (+new Date - h);
                                t._setStat(d, "googRetransmitBitrate", Math.floor(8 * T * 1e3))
                            }
                            if (v.bytesSent && E && E.bytesSent) {
                                var y = (v.bytesSent - E.bytesSent) / (+new Date - h);
                                t._setStat(d, "googTransmitBitrate", Math.floor(8 * y * 1e3)),
                                t._setStat(d, "googActualEncBitrate", Math.floor(8 * y * 1e3))
                            }
                            if (v.totalPacketSendDelay && E && E.totalPacketSendDelay) {
                                var R = (v.totalPacketSendDelay - E.totalPacketSendDelay) / (+new Date - h);
                                t._setStat(d, "googBucketDelay", Math.floor(1e3 * R))
                            }
                        }
                        if ((v = p.get("remote-inbound-video")) && (t._setStat(a, "packetsLost", v.packetsLost),
                        t._setStat(a, "googRtt", v.roundTripTime)),
                        (v = p.get("local-video-track")) && (t._setStat(a, "googFrameHeightSent", v.frameHeight),
                        t._setStat(a, "googFrameWidthSent", v.frameWidth),
                        void 0 !== v.framesPerSecond && t._setStat(a, "googFrameRateSent", v.framesPerSecond)),
                        (v = p.get("local-audio-track")) && (t._setStat(i, "googEchoCancellationReturnLoss", v.echoReturnLoss),
                        t._setStat(i, "googEchoCancellationReturnLossEnhancement", v.echoReturnLossEnhancement)),
                        (v = p.get("media-source-video")) && (t._setStat(a, "googFrameHeightInput", v.height),
                        t._setStat(a, "googFrameWidthInput", v.width),
                        t._setStat(a, "googFrameRateInput", v.framesPerSecond)),
                        (v = p.get("media-source-audio")) && t._setStat(i, "audioInputLevel", 32767 * v.totalAudioEnergy),
                        (v = p.get("inbound-video")) && (t._setStat(a, "googFirsReceived", v.firCount),
                        t._setStat(a, "googNacksReceived", v.nackCount),
                        t._setStat(a, "googPlisReceived", v.pliCount)),
                        S)
                            p.get("candidatePairs").map((function(e) {
                                S == e.transportId && t._setStat(d, "googAvailableSendBandwidth", e.availableOutgoingBitrate)
                            }
                            ));
                        else {
                            var A = p.get("candidatePairs")[0];
                            A && t._setStat(d, "googAvailableSendBandwidth", A.availableOutgoingBitrate)
                        }
                    }
                    t.lastStats = p;
                    var O = [_()({}, a), _()({}, i), _()({}, c), _()({}, s), _()({}, d)];
                    O.push({
                        id: "time",
                        startTime: t.connectedTime,
                        timestamp: new Date
          ...
          , O = function(e) {
            ...
            t.getStatsRate = function(e) {
                t.getStats((function(t) {
                    t.forEach((function(e) {
                        "outbound-rtp" === e.type && "video" === e.mediaType && e.googFramesEncoded && (e.googFrameRateSent = ((e.googFramesEncoded - p) / 3).toString(),
                        p = e.googFramesEncoded),
                        ...
                        e.googFrameRateDecoded && (e.googFrameRateDecoded = ((e.googFramesDecoded - f) / 3).toString(),
                        f = e.googFramesDecoded))
                    }
                    )),
                    e(t)
                }
            ...
            t.onstablestate = function() {
                ...
                if (t.actionNeeded) {
                    if ("new" === t.state || "established" === t.state) {
                        if (e.isSubscriber)
                            t.peerConnection.addTransceiver("audio", {
                                direction: "recvonly"
                            }),
        ...
        var w = function(e) {
                ...
                t.peerConnection.getStats().then((function(n) {
                    ...
                    try {
                        for (a.s(); !(i = a.n()).done; ) {
                            var r = i.value;
                            if (t.isSubscriber) {
                                if (("inbound-rtp" === r.type || "inboundrtp" === r.type) && "video" === r.mediaType) {
                                    if (!t.lastReport)
                                        return void (t.lastReport = r);
                                    e && e({
                                        browser: "firefox",
                                        mediaType: "video",
                                        peerId: t.uid,
                            ...
                            } else if (("outbound-rtp" === r.type || "outboundrtp" === r.type) && "video" === r.mediaType) {
                                if (!t.lastReport)
                                    return void (t.lastReport = r);
                                e && e({
                                    mediaType: "video",
            ...
            t.getAudioRelatedStats = function(e) {
                t.peerConnection.getStats().then((function(n) {
                    ...
                    try {
                        for (a.s(); !(i = a.n()).done; ) {
                            var r = i.value;
                            t.isSubscriber && ("inbound-rtp" !== r.type && "inboundrtp" !== r.type || "audio" !== r.mediaType || e && e({
                                browser: "firefox",
                                mediaType: "audio",
                                peerId: t.uid,
                                isAudioMute: t.isAudioMute,
                                frameDropped: r.packetsLost + "",
                                frameReceived: r.packetsReceived + "",
                                googJitterReceived: r.jitter + "",
                                bytesReceived: r.bytesReceived + "",
                                packetsReceived: r.packetsReceived + "",
                                packetsLost: r.packetsLost + ""
                            }))
            ...
            t._getStats = function(e) {
                t.peerConnection.getStats().then((function(n) {
                    var i, r = [], o = C(n.values());
                    try {
                        for (o.s(); !(i = o.n()).done; ) {
                            var u = i.value;
                            r.push(u),
                            "outbound-rtp" !== u.type && "outboundrtp" !== u.type || "video" !== u.mediaType || -1 !== u.id.indexOf("rtcp") || (s.id = u.id,
                            s.type = u.type,
                            s.mediaType = u.mediaType,
                            s.bytesSent = u.bytesSent ? u.bytesSent + "" : "0",
                            s.packetsSent = u.packetsSent ? u.packetsSent + "" : "0",
                            s.googPlisReceived = u.pliCount ? u.pliCount + "" : "0",
                            s.googNacksReceived = u.nackCount ? u.nackCount + "" : "0",
                            s.googFirsReceived = u.firCount ? u.firCount + "" : "0",
                            s.googFrameRateSent = u.framerateMean ? u.framerateMean + "" : "0"),
                            "outbound-rtp" !== u.type && "outboundrtp" !== u.type || "audio" !== u.mediaType || -1 !== u.id.indexOf("rtcp") || (a.id = u.id,
                            a.type = u.type,
                            a.mediaType = u.mediaType,
                            a.bytesSent = u.bytesSent ? u.bytesSent + "" : "0",
                            a.packetsSent = u.packetsSent ? u.packetsSent + "" : "0"),
                            "inbound-rtp" !== u.type && "inboundrtp" !== u.type || "audio" !== u.mediaType || u.isRemote || -1 !== u.id.indexOf("rtcp") || (c.id = u.id,
                            c.type = u.type,
                            c.mediaType = u.mediaType,
                            c.bytesReceived = u.bytesReceived ? u.bytesReceived + "" : "0",
                            c.packetsLost = u.packetsLost ? u.packetsLost + "" : "0",
                            c.packetsReceived = u.packetsReceived ? u.packetsReceived + "" : "0",
                            c.googJitterReceived = u.jitter ? u.jitter + "" : "0"),
                            "inbound-rtp" !== u.type && "inboundrtp" !== u.type || "video" !== u.mediaType || u.isRemote || -1 !== u.id.indexOf("rtcp") || (d.id = u.id,
                            d.type = u.type,
                            d.mediaType = u.mediaType,
                            d.bytesReceived = u.bytesReceived ? u.bytesReceived + "" : "0",
                            d.googFrameRateReceived = u.framerateMean ? u.framerateMean + "" : "0",
                            d.googFramesDecoded = u.framesDecoded ? u.framesDecoded + "" : "0",
                            d.packetsLost = u.packetsLost ? u.packetsLost + "" : "0",
                            d.packetsReceived = u.packetsReceived ? u.packetsReceived + "" : "0",
                            d.googJitterBufferMs = u.jitter ? u.jitter + "" : "0",
                            d.googNacksSent = u.nackCount ? u.nackCount + "" : "0",
                            d.googPlisSent = u.pliCount ? u.pliCount + "" : "0",
                            d.googFirsSent = u.firCount ? u.firCount + "" : "0"),
                            -1 !== u.id.indexOf("outbound_rtcp_video") && (s.packetsLost = u.packetsLost ? u.packetsLost + "" : "0")
                        }
                    } catch (e) {
                        o.e(e)
                    } finally {
          ...
          , W = function(e) {
            ...
            t = w(e)) : "iOS" === g.getBrowserOS() || g.isSafari() ? (o.default.debug("[" + t.streamId + "][" + t.clientId + "]Safari"),
            (t = O(e)).browser = "safari") : ~window.navigator.userAgent.indexOf("Edge") ? t = new k.a(e) : (t = A(e)).browser = "chrome-stable",
            t
        }
          , H = function(e, t, n) {
            var i = {};
            ...
            e.video || e.audio || e.screen || e.screenAudio) {
                ...
                if (e.screen) {
                    if (U())
                        return e.screen.sourceId ? j(e.screen.sourceId, e.screen, (function(t, n) {
                            t ? u(t) : (e.audio && (r++,
                            l()),
                            d(n))
                        }
                        )) : F(e.screen, (function(t, n) {
                            t ? u(t) : (e.audio && (r++,
                            l()),
                            d(n))
                        }
                    ...
                    if (g.isFireFox()) {
                        ...
                        if (window.navigator.mediaDevices.getDisplayMedia) {
                            ...
                            e.screenAudio && (p.audio = e.screenAudio),
                            o.default.debug("use getDisplayMedia, constraints:", p),
        ...
        function oe(e) {
            ...
            c = 0;
            for (var f = 0; f < 0 + a; f++) {
                var g = [o[c = (c + o[p = (p + 1) % 256]) % 256], o[p]];
                o[p] = g[0],
                o[c] = g[1],
                l = o[(o[p] + o[c]) % 256],
                f >= 0 && (r[f - 0] = i[f - 0] ^ l)
        ...
        function se(e, t) {
            var n = oe(t)
              , i = ae.a.createProgramFromSources(e, [oe(re), n])
        ...
        function Se(e, t, n) {
            ...
            this.setUniforms = function() {
                ...
                i.uniform1f(S, o);
                var _ = i.getUniformLocation(this.program, "skin_he_max")
                  , h = i.getUniformLocation(this.program, "skin_he_min")
        ...
        function he() {
            ...
            e.render = function(s) {
                if (t) {
                    ...
                    for (var d = _e ? e.programs.length - 1 : 0, u = 0; u <= d; u++) {
            ...
            e.init = function(i, a, r) {
                ...
                e.gl = t,
                e._initGl(i, a),
                e.programs.push(new de(this,i,a)),
                e.programs.push(new le(this,i,a)),
                e.programs.push(new fe(this,i,a)),
                e.programs.push(new me(this,i,a)),
                e.programs.push(new Se(this,i,a)),
        ...
        he._instance = null,
        he.getInstance = function() {
            return he._instance || (he._instance = new he),
            he._instance
        }
        ;
        var Ee = {
            addVideoEffectCapability: function(e) {
                ...
                e._enableEffect = function() {
                    ...
                    )) : (o.default.warning("Video track is null, fail to enable video effect!"),
                    Promise.resolve())
                }
                ,
                ...
                e.setBeautyEffectOptions = function() {
                    var t = ee()($.a.mark((function t(n, i) {
                        var a, r = arguments;
                        return $.a.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    if (Object(z.checkValidBoolean)(n, "enabled"),
                                    a = he.getInstance(),
                                ...
                                case 16:
                                    ...
                                    Object(z.checkValidObject)(i, "options"),
                                    t.next = 21;
                                    break;
                                case 20:
                                    return t.abrupt("return");
                                case 21:
                                    if (void 0 !== i.smoothnessLevel && (Object(z.checkValidFloatNumber)(i.smoothnessLevel, "smoothnessLevel", 0, 1),
                                    ...
                                    void 0 !== i.lighteningLevel && (Object(z.checkValidFloatNumber)(i.lighteningLevel, "lighteningLevel", 0, 1),
                                    ...
                                    void 0 !== i.rednessLevel && (Object(z.checkValidFloatNumber)(i.rednessLevel, "rednessLevel", 0, 1),
          ...
          , Te = a.n(Ie)
          , ye = function(e) {
            Object(z.checkValidString)(e, "profileName"),
            -1 === (e = e.toLowerCase()).indexOf("_") && (e += "_1"),
            Object(z.checkValidEnum)(e, "profileName", Object.keys(r.SUPPORT_RESOLUTION_LIST));
        ...
        var Ae = function(e) {
            ...
            function(e) {
                ...
                e.loadAudioBuffer = function(t, n, i) {
                    ...
                    Object(z.checkValidString)(n, "url", 1, 1024, !1),
                    Object(z.checkValidString)(t, "id", 1, 1024, !1);
                    var r = function(t) {
                ...
                e.createAudioBufferSource = function(t) {
                    ...
                    return o.default.error("[".concat(e.streamId, "] "), u, t.id),
                    n(!1),
                    !1
                }
                ,
                ...
                e._playOneEffect = function(t, n) {
                    Object(z.checkValidObject)(t, "options");
                    var i = t.soundId
                      , a = (t.filePath,
                    t.cacheResource);
                    t.cycle,
                    ...
                    t.playTime,
                    t.replace;
                    if (Object(g.isSafari)() && Object(g.getBrowserVersion)() < 12) {
                    ...
                    if (s.state === e.audioMixing.states.IDLE) {
                        if (void 0 !== t.cycle && !t.cycle > 0) {
                            r = "Invalid Parmeter cycle: " + t.cycle;
                            return o.default.error("[".concat(e.streamId, "] ").concat(i), r),
                            n(r)
                        }
                        if (Object(z.isEmpty)(a) && (t.cacheResource = !0),
                ...
                e.startAudioMixing = function(t, n) {
                    ...
                    var a = t.filePath
                      ...
                      , u = t.playTime
                      , l = t.replace;
                    Object(z.checkValidString)(a, "filePath", 1, Object(r.getParameter)("FILEPATH_LENMAX"), !1),
                    Object(z.checkValidNumber)(u, "playTime", 0, 1e8),
                    !Object(z.isEmpty)(c) && Object(z.checkValidNumber)(c, "cycle"),
                    !Object(z.isEmpty)(d) && Object(z.checkValidBoolean)(d, "loop"),
                    !Object(z.isEmpty)(l) && Object(z.checkValidBoolean)(l, "replace"),
                    !Object(z.isEmpty)(o) && Object(z.checkValidBoolean)(o, "cacheResource");
                    var p = _()({
                        soundId: -1
                    }, t);
                ...
                e.adjustAudioMixingVolume = function(t) {
                    ...
                    Object(z.checkValidNumber)(t, "volume", 0, 100),
                ...
                e.setAudioMixingPosition = function(t, n) {
                    ...
                    Object(z.checkValidNumber)(t, "position", 0, 1e8),
                ...
                e.playEffect = function(t, n) {
                    ...
                    var a = t.soundId
                      , o = t.filePath
                      , c = t.cycle;
                    Object(z.checkValidNumber)(a, "soundId", 1, 1e4),
                    Object(z.checkValidString)(o, "filePath", 0, Object(r.getParameter)("FILEPATH_LENMAX"), !1),
                    !Object(z.isEmpty)(c) && Object(z.checkValidNumber)(c, "cycle"),
                ...
                e.stopEffect = function(t, n) {
                    ...
                    Object(z.checkValidNumber)(t, "soundId", 1, 1e4),
                    e._stopOneEffect({
                        soundId: t
                    }, i)
                }
                ...
                e.preloadEffect = function(t, n, i) {
                    ...
                    Object(z.checkValidNumber)(t, "soundId", 1, 1e4),
                    Object(z.checkValidString)(n, "filePath", 1, Object(r.getParameter)("FILEPATH_LENMAX"), !1),
                ...
                e.setEffectsVolume = function(t, n) {
                    ...
                    for (var a in Object(z.checkValidNumber)(t, "volume", 0, 100),
                ...
                e.setVolumeOfEffect = function(t, n, i) {
                    ...
                    Object(z.checkValidNumber)(t, "soundId", 0, 1e4),
                    Object(z.checkValidNumber)(n, "volume", 0, 100),
            ...
            function(e, t) {
                ...
                e.setVideoResolution = function(n) {
                    ...
                    if (!(n instanceof Array)) {
                        var a = ye(n += "");
                        return a && a.video ? (e.videoConstraint = _()(e.videoConstraint, {
                            width: {
                                ideal: a.video.width
                            },
                            height: {
                    ...
                    var r, c = n[0], d = n[1];
                    e.videoConstraint = _()(e.videoConstraint, {
                        width: {
                            ideal: c
                        },
                        height: {
                    ...
                    (r = e.stream && e.stream.getVideoTracks && e.stream.getVideoTracks()[0]) && r.applyConstraints ? (o.default.debug("setVideoResolution applyConstraints", e.videoConstraint),
                    Ee.disableVideoEffect(e).then((function() {
                        return r.applyConstraints(e.videoConstraint).then(i).catch(i)
                    }
                    )).then((function() {
                        return Ee.restoreVideoEffect(e)
                    }
                    ))) : i()
                }
                ,
                e.setVideoFrameRate = function(t) {
                    ...
                    if (Object(g.isFireFox)())
                        return n("FIREFOX_NOT_SUPPORTED"),
                        !1;
                    if ("object" === Te()(t) && t instanceof Array && t.length > 1) {
                        e.videoConstraint = _()(e.videoConstraint, {
                            frameRate: {
                                ideal: t[0],
                                max: t[1]
                        ...
                        e.attributes.minFrameRate = t[0],
                        e.attributes.maxFrameRate = t[1];
                        var i = e.stream && e.stream.getVideoTracks && e.stream.getVideoTracks()[0];
                        return i && i.applyConstraints ? (o.default.debug("setVideoFrameRate applyConstraints", e.videoConstraint),
                        i.applyConstraints(e.videoConstraint).then(n).catch(n)) : n(),
                        !0
                    }
                    return n("INVALID_PARAM_".concat(JSON.stringify(t))),
                    !1
                }
                ,
                e.setVideoBitRate = function(n) {
                    ...
                    return "object" === Te()(n) && n instanceof Array && n.length > 1 ? (t.attributes.minVideoBW = n[0],
                ...
                e.setScreenBitRate = function(t) {
                    ...
                    return "object" === Te()(t) && t instanceof Array && t.length > 1 ? (e.screenAttributes.minVideoBW = t[0],
                    e.screenAttributes.maxVideoBW = t[1],
                    n(),
                    !0) : (n("INVALID_PARAM_".concat(JSON.stringify(t))),
                    !1)
                }
                ,
                e.setScreenProfile = function(t) {
                    ...
                    Object(z.checkValidEnum)(t, "profile", ["480p_1", "480p_2", "720p_1", "720p_2", "1080p_1", "1080p_2"]);
                    var i = ye(t);
                    ...
                    e.screenConstraint.mandatory.maxFrameRate = i.screen.frameRate.max)) : e.screenConstraint = _()(e.screenConstraint, i.screen),
                ...
                e.setVideoProfile = function(n) {
                    ...
                    a && a.video) {
                        ...
                        e.videoConstraint = _()(e.videoConstraint, a.video),
                        ...
                        t.attributes = _()(t.attributes, a.attributes),
                        e.pc && e.pc.renegotiate && e.pc.renegotiate();
                        ...
                        Ee.disableVideoEffect(e).then((function() {
                            ...
                            return new Promise((function(n, a) {
                                i(t),
                                Object(G.vsResHack)(e.stream, (function(t, i) {
                                    e.videoWidth = t,
                                    e.videoHeight = i,
                                    n()
                                }
                ...
                e.setAudioProfile = function(t) {
                    ...
                    Object(z.checkValidEnum)(t, "profile", ["speech_low_quality", "speech_standard", "music_standard", "standard_stereo", "high_quality", "high_quality_stereo"]),
                    e.audioProfile = t;
                    var i = Re(t);
                ...
                e.setVideoEncoderConfiguration = function(t) {
                    Object(z.checkValidObject)(t, "config");
                    var n = s.b.reportApiInvoke(e.sid, {
                        name: "Stream.setVideoEncoderConfiguration",
                        options: t,
                        tag: "tracer"
                    });
                    t.resolution && (Object(z.checkValidNumber)(t.resolution.width, "config.resolution.width"),
                    Object(z.checkValidNumber)(t.resolution.height, "config.resolution.height"),
                    e.setVideoResolution([t.resolution.width, t.resolution.height])),
                    t.frameRate && (Object(z.checkValidNumber)(t.frameRate.min, "config.frameRate.min"),
                    Object(z.checkValidNumber)(t.frameRate.max, "config.frameRate.max"),
                    e.setVideoFrameRate([t.frameRate.min, t.frameRate.max])),
                    t.bitrate && (Object(z.checkValidNumber)(t.bitrate.min, "config.bitrate.min", 1, 1e7),
                    Object(z.checkValidNumber)(t.bitrate.max, "config.bitrate.max", 1, 1e7),
                ...
                e.getSupportedProfile = function(t) {
                    ...
                    if (!a) {
                        i = "NO_VIDEO_TRACK_FOUND";
                        return o.default.error(i),
                        n(i)
                    }
                    if (!a.getCapabilities) {
                        i = "GETCAPABILITY_NOT_SUPPORT";
                        return o.default.error(i),
                        n(i)
                    }
            ...
            t.init = function(i, a) {
                ...
                t._streamInitID = d,
                t.videoSource ? t.videoName = "videoSource" : t.video && (t.videoName = K.searchDeviceNameById(e.cameraId) || "default"),
                t.audioSource ? t.audioName = "audioSource" : t.audio && (t.audioName = K.searchDeviceNameById(e.microphoneId) || "default"),
                ...
                try {
                    if (e.audio || e.video || e.screen || e.screenAudio || e.videoSource || e.audioSource) {
                        ...
                        H(u, (function(i) {
                            ...
                            t.initialized = !0,
                            t.reloadDeviceName(),
                            t.hasVideo() && Object(G.vsResHack)(i, (function(e, n) {
                                t.videoWidth = e,
                                t.videoHeight = n
                            }
                            ), (function(e) {
            ...
            t.close = function() {
                ...
                void 0 !== t.stream) {
                    ...
                    !t.isLowStream && t.local ? Ee.disableVideoEffect(t).then((function() {
                        t.stream = void 0
                    }
                    )) : (t.stream && t.stream.clean && t.stream.clean(),
                    t.stream = void 0)
                }
                if (Object(g.isSafari)() && t.pc && t.pc.peerConnection && t.pc.peerConnection.removeTrack && t.pc.peerConnection.getSenders) {
                    var a = t.pc.peerConnection.getSenders();
            ...
            t.setAudioOutput = function(e, n, i) {
                ...
                return Object(z.isValidString)(e, 1, 255) ? (t.audioOutput = e,
            ...
            t.play = function(e, n, i) {
                ...
                if (Object(z.checkValidString)(e, "elementID"),
                Object(z.isEmpty)(n) || (Object(z.isEmpty)(n.fit) || Object(z.checkValidEnum)(n.fit, "fit", ["cover", "contain"]),
                Object(z.isEmpty)(n.muted) || Object(z.checkValidBoolean)(n.muted, "muted")),
                t.player)
                    ...
                    t.local && Ee.applyEffectInPlayer(t)) : t.hasAudio() && (t.player = new y({
                        id: t.getId(),
                        stream: t,
                        elementID: e,
                        options: n
            ...
            t.stop = function() {
                ...
                t.player ? (Ee.removeEffectFromLocalPlayer(t),
                t.player.destroy(),
            ...
            t.setAudioVolume = function(e) {
                ...
                Object(z.checkValidNumber)(e, "level", 0, 100),
                t.audioLevel = e,
            ...
            t.getStats = function(e, n, i) {
                ...
                a.push(new Promise((function(e) {
                    var n = {};
                    t.pc && t.pc.isSubscriber ? null !== window.navigator.userAgent.match("Firefox") && (q(n, "videoReceiveResolutionHeight", t.videoHeight),
                    q(n, "videoReceiveResolutionWidth", t.videoWidth)) : t.pc && !t.pc.isSubscriber && ((Object(g.isSafari)() || Object(g.isFireFox)()) && (q(n, "videoSendResolutionHeight", t.videoHeight),
                    q(n, "videoSendResolutionWidth", t.videoWidth)),
                    (Object(g.isSafari)() || Object(g.isFireFox)()) && t.uplinkStats && q(n, "videoSendPacketsLost", t.uplinkStats.uplink_cumulative_lost)),
                    e(n)
                }
                ))),
                a.push(new Promise((function(e) {
                    var n = {};
                    return t.traffic_stats && t.pc && t.pc.isSubscriber ? (q(n, "accessDelay", t.traffic_stats.access_delay),
                    q(n, "endToEndDelay", t.traffic_stats.e2e_delay),
                    q(n, "videoReceiveDelay", t.traffic_stats.video_delay),
                    q(n, "audioReceiveDelay", t.traffic_stats.audio_delay)) : t.traffic_stats && t.pc && !t.pc.isSubscriber && q(n, "accessDelay", t.traffic_stats.access_delay),
                    e(n)
                }
                ))),
            ...
            t._getPCStats = function(e) {
                return new Promise((function(n, i) {
                    ...
                    t.pc.getStats((function(e) {
                        ...
                        var a = t.pc.isSubscriber ? function(e) {
                            ...
                            return e.forEach((function(e) {
                                e.id && e.type && (-1 === e.id.indexOf("recv") && -1 === e.type.toLowerCase().indexOf("inbound") && -1 === e.id.indexOf("inbound_rtp") && -1 === e.id.indexOf("inbound-rtp") && -1 === e.id.indexOf("InboundRTP") || ("audio" === e.mediaType ? (q(t, "audioReceiveBytes", e.bytesReceived),
                                q(t, "audioReceivePackets", e.packetsReceived),
                                q(t, "audioReceivePacketsLost", e.packetsLost)) : (q(t, "videoReceiveBytes", e.bytesReceived),
                                q(t, "videoReceivePacketsLost", e.packetsLost),
                                q(t, "videoReceivePackets", e.packetsReceived),
                                q(t, "videoReceiveFrameRate", e.googFrameRateReceived),
                                q(t, "videoReceiveDecodeFrameRate", e.googFrameRateDecoded),
                                q(t, "videoReceiveResolutionWidth", e.googFrameWidthReceived),
                                q(t, "videoReceiveResolutionHeight", e.googFrameHeightReceived))))
                            }
                            )),
                            t
                        }(e) : function(e) {
                            var t = {};
                            return e.forEach((function(e) {
                                e.id && e.type && (-1 === e.id.indexOf("send") && -1 === e.type.toLowerCase().indexOf("outbound") && -1 === e.id.indexOf("outbound_rtp") && -1 === e.id.indexOf("OutboundRTP") || ("audio" === e.mediaType ? (q(t, "audioSendBytes", e.bytesSent),
                                q(t, "audioSendPackets", e.packetsSent),
                                q(t, "audioSendPacketsLost", e.packetsLost)) : (q(t, "videoSendBytes", e.bytesSent),
                                q(t, "videoSendPackets", e.packetsSent),
                                q(t, "videoSendPacketsLost", e.packetsLost),
                                q(t, "videoSendFrameRate", e.googFrameRateSent),
                                q(t, "videoSendResolutionWidth", e.googFrameWidthSent),
                                q(t, "videoSendResolutionHeight", e.googFrameHeightSent))))
                            }
                            )),
                            t
                        }(e);
                    ...
                    return t.pc.isSubscriber ? (Object(g.isFireFox)() || Object(g.isSafari)()) && (e.videoReceiveResolutionHeight && "0" !== e.videoReceiveResolutionHeight || e.videoReceiveResolutionWidth && "0" !== e.videoReceiveResolutionWidth || (q(e, "videoReceiveResolutionHeight", t.videoHeight),
                    q(e, "videoReceiveResolutionWidth", t.videoWidth))) : ((Object(g.isSafari)() || Object(g.isFireFox)()) && (e.videoSendResolutionHeight && "0" !== e.videoSendResolutionHeight || e.videoSendResolutionWidth && "0" !== e.videoSendResolutionWidth || (q(e, "videoSendResolutionHeight", t.videoHeight),
                    q(e, "videoSendResolutionWidth", t.videoWidth))),
                    (Object(g.isSafari)() || Object(g.isFireFox)()) && t.uplinkStats && q(e, "videoSendPacketsLost", t.uplinkStats.uplink_cumulative_lost)),
                    Promise.resolve(e)
                }
                ))
            }
            ...
            t.getAudioLevel = function() {
                ...
                if (t.stream) {
                    if (0 !== t.stream.getAudioTracks().length)
                        return t.audioLevelHelper = new G.audioLevelHelper(t.stream),
                ...
                H(a, (function(a) {
                    try {
                        var r = function() {
                            ...
                            Ee.restoreVideoEffect(t).then((function() {
                                n && n()
                            }
                            ))
                        };
                        Ee.disableVideoEffect(t).then((function() {
            ...
            t.switchDevice = function(e, n, i, a) {
                ...
                Object(z.checkValidString)(n, "deviceId");
                var c = function() {
                ...
                for (var l in t.audioMixing.sounds) {
                    var p = t.audioMixing.sounds[l];
                    if (p.state !== t.audioMixing.states.IDLE) {
                        u = !0;
                        break
                    }
                }
          ...
          , Ce = a(8)
          , Ne = a.n(Ce)
          , we = ["live", "rtc", "web", "interop", "h264_interop", "web-only"]
          , De = ["vp8", "h264"]
          , ke = ["aes-128-xts", "aes-256-xts", "aes-128-ecb"]
          , Le = a(16)
          , Me = a.n(Le)
          , Pe = function(e) {
          ...
          , Ue = function(e) {
            ...
            t.connectNext = function() {
                ...
                t.hostIndex >= t.host.length ? t.dispatchEvent(p({
                    type: "recover"
                })) : t.creatConnection()
            }
            ,
            ...
            t.creatConnection = function() {
                ...
                t.connection.onmessage = function(e) {
                    if (e.data instanceof ArrayBuffer)
                        ...
                        t.recvbytes += Object(G.lengthInUtf8Bytes)(e.data);
                        var n = JSON.parse(e.data);
                        t.lastMsgTime = Date.now(),
                        n.hasOwnProperty("_id") ? t.dispatchEvent(p({
                            type: n._id,
                            msg: n
                        })) : n.hasOwnProperty("_type") && t.dispatchSocketEvent(p({
                            type: n._type,
                            msg: n._message
                        }))
                    }
                ...
                t.connection.onclose = function(n) {
                    ...
                    t.connectNext()) : (t.dispatchEvent(p({
                        type: "disconnect",
                        event: n
                    })),
            ...
            t.sendMessage = function(e, n) {
                if (t.connection && t.connection.readyState == WebSocket.OPEN) {
                    ...
                    t.sendbytes += Object(G.lengthInUtf8Bytes)(i),
                    t.connection.send(i)
                } else
                    n({
            ...
            return t.sendRequest = function(e, a) {
                e = _()({
          ...
          , je = function(e, t) {
            ...
            Object(r.getParameter)("PROXY_CS").map((function(c) {
                ...
                Fe("https://" + c + "/api/v1", a, (function(a, u) {
                    if (a)
          ...
          , Ye = function(e, t, n, i) {
            ...
            Object(xe.post)(e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=wrtc_gateway"), u, (function(d) {
                try {
                    var u = JSON.parse(d);
                    u.res && (u = u.res);
                    var l = u.code
                } catch (e) {
                    var p = "requestChooseServer failed with unexpected body " + d;
                    return o.default.error("[" + c.clientId + "]", p),
                    i(p)
                }
                if (l) {
                    var f = I.APErrorCode[u.code] || l;
              ...
              , p = function t(d, p) {
                if (!i) {
                    ...
                    He({
                        ...
                        qe[l] !== ot.DISCONNECTED && qe[l] !== ot.DISCONNECTING ? f && p && p(v, u) : o.default.debug("[".concat(e.clientId, "] Request config success when connection state is ").concat(qe[l]))
                    }
                    )),
                    function(e, t, n) {
                        for (var i = (new Date).getTime(), a = !1, c = !0, d = function(n, r) {
                            ...
                            n(a)))
                        }, l = Object(r.getParameter)("WEBCS_DOMAIN"), p = 0; p < l.length; ++p) {
                            var f;
                            if ("string" == typeof l[p]) {
                                var g = l[p];
                                f = e.proxyServer ? "https://".concat(e.proxyServer, "/ap/?url=").concat(g + "/api/v1") : "https://".concat(g, "/api/v1"),
                                o.default.debug("[" + e.clientId + "] " + "Connect to choose_server: ".concat(f)),
                                Ye(f, e, d, u)
                            } else
                            ...
                            if (!a)
                                for (var t = Object(r.getParameter)("WEBCS_DOMAIN_BACKUP_LIST"), n = 0; n < t.length; ++n) {
                                    if ("string" == typeof t[n]) {
                                        ...
                                        o.default.debug("[" + e.clientId + "] " + "Connect to backup_choose_server: ".concat(f)),
                                        Ye(f, e, d, u)
                                    } else
                        ...
                        v = t,
                        clearTimeout(a),
                        qe[l] !== ot.DISCONNECTED && qe[l] !== ot.DISCONNECTING ? m && p && p(v, u) : o.default.debug("[".concat(e.clientId, "] Request gateway list success when connection state is ").concat(qe[l]))
                    }
                    ), (function(i) {
                        if (i)
                            return o.default.info("[" + e.clientId + "] Join failed: " + i),
                            void (n && n(i));
                        if (qe[l] === ot.DISCONNECTED || qe[l] === ot.DISCONNECTING)
                            return o.default.debug("[".concat(e.clientId, "] Request gateway list falied when connection state is ").concat(qe[l])),
              ...
              , f = function n() {
                !function(e, t) {
                    ...
                    if (i) {
                        ...
                        s.b.setProxyServer(f),
                        o.default.setProxyServer(f),
                        p(f, t)
                    }
                }
                ))
            };
            e.useProxyServer ? 1 == e.proxyServerType ? f() : 2 == e.proxyServerType ? function n() {
                !function(e, t) {
                    je(e, (function(n, i) {
                        return n ? t && t(n) : (o.default.debug("[" + e.clientId + "] getProxyServerList: ", i),
                        t && t(null, {
                            address: i[0],
                            serverResponse: {
                                tcpport: "443",
                    ...
                    if (i)
                        return o.default.debug("[" + e.clientId + "]", i),
                        o.default.debug("[" + e.clientId + "] Request proxy will be restart in " + d + "s"),
                        a = setTimeout((function() {
                            n()
                        }
                    ...
                    clearTimeout(a);
                    var u = Object(r.getParameter)("PROXY_SERVER_TYPE2");
                    e.proxyServer = u;
                    var f = {
                        mode: "manual",
                        url: c.address,
                    ...
                    f.udpport += "",
                    e.turnServers = [],
                    e.turnServers.push(f),
                    s.b.setProxyServer(u),
                    o.default.setProxyServer(u),
                    p(u, t)
                }
                ))
            }() : f() : p(null, t)
          ...
          , ze = function(e, t, n, i) {
            ...
            return new Promise((function(c, d) {
                Object(xe.post)(e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=stringuid"), r, (function(u) {
                    try {
                        var l = JSON.parse(u)
                          , p = l.code
                    } catch (c) {
                        var f = "requestUserAccount failed with unexpected body " + u;
                        return o.default.error("[" + t.clientId + "]", f),
                        d({
                            retryable: !0,
                            info: f,
                            url: e
                    ...
                    if (p) {
                        var g = I.StringUidErrorCode[l.code % 1e4] || "REQ_ACCOUNT_ERR_".concat(p);
                        ...
                        d({
                            retryable: !1,
                            info: f = "Get String Uid Failed [" + g + "]",
                            url: e,
                            error: g
                        })
                    }
          ...
          , Xe = function(e, t, n) {
            Date.now();
            var a, s = Object(r.getParameter)("ACCOUNT_REGISTER"), c = !1, d = Object(r.getParameter)("ACCOUNT_REGISTER_RETRY_TIMEOUT"), u = null, l = null, p = new Promise(function() {
                var p = ee()($.a.mark((function p(f, g) {
                    var m, v, S;
                    return $.a.wrap((function(p) {
                        for (; ; )
                            ...
                            case 6:
                                ...
                                p.prev = 8,
                                p.delegateYield($.a.mark((function i() {
                                    var a;
                            ...
                            case 19:
                                ...
                                o.default.error("".concat(p.t1.info, " ").concat(p.t1.url, " Will Fetch User Account in ").concat(d / 1e3, " seconds")),
                                p.next = 25,
                            ...
                            case 25:
                                ...
                                break;
                            case 27:
                                o.default.error("Get UserAccount Error: ".concat(p.t1.info, " ").concat(p.t1.url), p.t1.error),
                                c = !0,
                                l(p.t1);
                            case 30:
                                a++,
        ...
        for (var et in $e) {
            var tt = $e[et];
            Ze[tt] && o.default.error("Key Conflict: ".concat(tt, ": ").concat($e[tt], "| ").concat(et)),
            Ze[tt] = et
        }
        var nt = function(e) {
            return $e[e] || e
        ...
        var at = function t(n) {
            var i = !1
              ...
              , d = function(e, t) {
                ...
                return Object.keys(t).forEach((function(e) {
                    Object(r.getParameter)("STATS_FILTER")[e] || (n[nt(e)] = t[e])
                }
                )),
                {
            ...
            b.subscribeRequestId = new Map,
            b.publishRequestId = 0,
            b.hasJoined = !1,
            b.isFirstSuccess = !0,
            function(e) {
                var t = Pe;
            ...
            b._sendMessage = function(e, t) {
                switch (e) {
                case "SubscribeStats":
                    b.makeReport(v.apply(void 0, Me()(t)));
                    break;
                case "SubscribeRelatedStats":
                    b.makeReport(d.apply(void 0, Me()(t)))
                }
            }
            ;
            var R = Pe;
            b.p2pCounter = Object(G.random)(1e5),
                ...
                N(e, (function(t) {
                    ...
                    b.makeRequest(function(e) {
                        ...
                        if (s.b.joinGateway(e.sid, {
                            ...
                            firstSuccess: b.isFirstSuccess
                        }),
                        b.joinSuccessLts = Date.now(),
                        b.isFirstSuccess = !1,
                        b.rejoinAttempt = 0,
                        b.hasJoined = !0,
                        i && i(t.uid),
                        ...
                        b.timers.trafficStats = setInterval((function() {
                            b.makeRequest({
                                ...
                                b.traffic_stats = t,
                                b.traffic_stats.timestamp = Date.now();
                    ...
                    void 0 !== e.url)
                                ...
                                b.makeRequest(m({
                                    ...
                                    e.pc.oniceconnectionstatechange = function(t) {
                                        if ("failed" === t) {
                                            ...
                                            o.default.error("[".concat(b.clientId, "] Publisher connection is lost -- streamId: ").concat(e.getId(), ", p2pId: ").concat(p)),
                                            b.p2ps.delete(p),
                                            ...
                                            !d)
                                                ...
                                                s.b.publish(b.joinInfo.sid, {
                                                    ...
                                                    publishRequestid: b.publishRequestId || 0,
                                                    p2pid: p
                                                }),
                                                b.dispatchEvent(l({
                                                    type: "pubP2PLost",
                                            ...
                                            if (e.getId() == e.getUserId()) {
                                                ...
                                                setTimeout((function() {
                                                    ...
                                                    e > Object(r.getParameter)("REPORT_STATS_TIMEOUT") ? o.default.debug("PublishStats report blocked by REPORT_STATS_TIMEOUT ".concat(e)) : b.makeReport(function(e) {
                                                        var t = {};
                                                        return Object.keys(e).forEach((function(n) {
                                                            Object(r.getParameter)("STATS_FILTER")[n] || (t[nt(n)] = e[n])
                                                        }
                                                        )),
                                                        {
                                                            _type: "publish_stats",
                        ...
                        var f = function() {
                            Object(r.getParameter)("REPORT_STATS") && e && e.pc && e.pc.getVideoRelatedStats && e.pc.getVideoRelatedStats((function(t) {
                                ...
                                i = {},
                                Object.keys(n).forEach((function(e) {
                                    Object(r.getParameter)("STATS_FILTER")[e] || (i[nt(e)] = n[e])
                                }
                                )),
                                {
                        ...
                        f(),
                        clearInterval(b.timers[e.getId() + "_RelatedStats"]),
                        b.timers[e.getId() + "_RelatedStats"] = setInterval(f, 1e3)
                    }
                }
            }
            ,
                    ...
                    if (e.hasAudio() || e.hasVideo() || e.hasScreen()) {
                            ...
                            "ontrack" === n && "video" === t.track.kind || "onaddstream" === n) {
                                ...
                                b.remoteStreams[e.getId()].hasVideo()) {
                                    if (Object(g.isFireFox)() || Object(g.isSafari)()) {
                                        ...
                                        Object(G.vsResHack)(r, (function(t, n) {
                                            e.videoWidth = t,
                                            e.videoHeight = n
                                        }
                                        ), (function(e) {
                        ...
                        e.pc.oniceconnectionstatechange = function(a) {
                            if ("failed" === a)
                                ...
                                clearInterval(b.timers[e.getId()] + "audio")),
                                o.default.error("[".concat(b.clientId, "] Subscriber connection is lost -- streamId: ").concat(e.getId(), ", p2pId: ").concat(p)),
                                ...
                                s.b.subscribe(b.joinInfo.sid, {
                                    ...
                                    peerid: e.getId(),
                                    ec: I.default.PEERCONNECTION_FAILED,
                                    subscribeRequestid: b.subscribeRequestId.get(e.getId()) || 0,
                                    p2pid: p
                                })),
                                b.remoteStreams[e.getId()] && b.p2ps.has(p) && (b.p2ps.delete(p),
                                b.dispatchEvent(l({
                                    type: "subP2PLost",
                                    stream: e
                                })));
                            ...
                            !c)) {
                                ...
                                var r = !1
                                    ...
                                    r && d || (e.pc ? e.pc.getStats((function(t) {
                                        t.forEach((function(t) {
                                            if ((-1 !== t.id.indexOf("recv") || t.type && -1 !== t.type.toLowerCase().indexOf("inbound") || -1 !== t.id.indexOf("inbound_rtp") || -1 !== t.id.indexOf("inbound-rtp") || -1 !== t.id.indexOf("InboundRTP")) && "audio" === t.mediaType) {
                                                if ((t.googDecodingNormal > 0 || t.audioOutputLevel > 0) && !r) {
                                                    r = !0,
                                                    b.dispatchEvent({
                                                    ...
                                                    r && d && clearInterval(f);
                                                    var n = Date.now()
                                                      , i = s.b.getSessionStartTime(b.joinInfo.sid);
                                                ...
                                                if (parseInt(t.packetsReceived) > 0 && !d) {
                                                    d = !0,
                                                    b.dispatchEvent({
                                  ...
                                  , v = setInterval((function() {
                                    g && m || (e.pc ? e.pc.getStats((function(t) {
                                        t.forEach((function(t) {
                                            if ((-1 !== t.id.indexOf("recv") || t.type && -1 !== t.type.toLowerCase().indexOf("inbound") || -1 !== t.id.indexOf("inbound_rtp") || -1 !== t.id.indexOf("inbound-rtp") || -1 !== t.id.indexOf("InboundRTP")) && "video" === t.mediaType) {
                                                if ((t.framesDecoded > 0 || t.googFramesDecoded > 0) && !g) {
                                                    g = !0,
                                                    b.dispatchEvent({
                                  ...
                                  , S = setInterval((function() {
                                    if (!u) {
                                        var t = e.getId()
                                          , n = b.traffic_stats;
                                        if (n && n.peer_delay) {
                                            var i = n.peer_delay.find((function(e) {
                                                return e.peer_uid == t
                                            }
                                            ));
                                            if (i) {
                                                u = !0;
                                                var a = s.b.getSessionStartTime(b.joinInfo.sid)
                                                  , r = i.peer_publish_audio_duration + (Date.now() - n.timestamp)
                                                  , o = Date.now();
                                                s.b.peerPublishStatus({
                                                    lts: o,
                                                    sid: b.joinInfo.sid,
                                                    cname: b.joinInfo.cname,
                                                    cid: b.joinInfo.cid,
                                                    uid: b.joinInfo.uid,
                                                    elapse: o - a,
                                                    peer: t,
                                                    peerPublishDuration: r,
                                                    joinChannelSuccessElapse: o - b.joinSuccessLts,
                                                    subscribeElapse: o - e.subscribeLTS
                                                }),
                                                clearInterval(S)
                                            }
                                        }
                    ...
                    return $.a.wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                throw new Ce.ChannelMediaError("RELAY_ALREADY_START","",Ce.CHANNEL_MEDIA_RELAY_ERROR.RELAY_ALREADY_START);
                            case 2:
                                return n = function(e) {
                                    b.dispatchEvent({
                                ...
                                ,
                                i = function(e, t, n) {
                                    e === Ce.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE && t === Ce.CHANNEL_MEDIA_RELAY_ERROR.SERVER_CONNECTION_LOST && (b.channelMediaRelayController.dispose(),
                                    b.channelMediaRelayController = null),
                                    b.dispatchEvent({
                                ...
                                ,
                                b.channelMediaRelayController = new Ne.a(b.joinInfo,b.clientId),
                            ...
                            case 12:
                                ...
                                b.dispatchEvent({
                                    type: "channel-media-relay-state",
                                    state: Ce.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_IDLE
                                }),
                                new Ce.ChannelMediaError(r,null,Ce.CHANNEL_MEDIA_RELAY_ERROR[r]);
                            case 22:
                                b.dispatchEvent({
                                    type: "channel-media-relay-state",
                                    state: Ce.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_RUNNING,
                                    code: Ce.CHANNEL_MEDIA_RELAY_ERROR.RELAY_OK
                                }),
                    ...
                    return $.a.wrap((function(t) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                throw new Ce.ChannelMediaError("RELAY_NOT_START",null,Ce.CHANNEL_MEDIA_RELAY_ERROR.RELAY_NOT_START);
                            case 2:
                                return t.prev = 2,
                                t.next = 5,
                            ...
                            case 7:
                                ...
                                new Ce.ChannelMediaError(a,null,Ce.CHANNEL_MEDIA_RELAY_ERROR[a]);
                            case 18:
            ...
            b.stopChannelMediaRelay = ee()($.a.mark((function t() {
                var n, i;
                return $.a.wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        ...
                        case 7:
                            ...
                            n = Ce.CHANNEL_MEDIA_RELAY_STATE.RELAY_STATE_FAILURE,
                            i = "",
                            i = e instanceof Ce.ChannelMediaError ? e.message === Ce.CHANNEL_MEDIA_ERROR.REQUEST_TIMEOUT || e.message === Ce.CHANNEL_MEDIA_ERROR.WAIT_STATUS_TIMEOUT ? "SERVER_NO_RESPONSE" : e.message === Ce.CHANNEL_MEDIA_ERROR.REQUEST_FAILED || e.message === Ce.CHANNEL_MEDIA_ERROR.WAIT_STATUS_ERROR ? "SERVER_ERROR_RESPONSE" : "INTERNAL_ERROR" : "INTERNAL_ERROR",
                            b.dispatchEvent({
                                type: "channel-media-relay-state",
                                state: n,
                                code: Ce.CHANNEL_MEDIA_RELAY_ERROR[i]
                            }),
                            b.channelMediaRelayController && (b.channelMediaRelayController.dispose(),
                            b.channelMediaConfig = null,
                            b.channelMediaRelayController = null),
                            ...
                            new Ce.ChannelMediaError(i,null,Ce.CHANNEL_MEDIA_RELAY_ERROR[i]);
                        case 17:
                            b.channelMediaConfig = null,
                            b.channelMediaRelayController = null;
                        case 19:
                ...
                b.socket) {
                    ...
                    b.socket.on("on_p2p_lost", (function(e) {
                        ...
                        "subscribe" === e.event && s.b.subscribe(b.joinInfo.sid, {
                            ...
                            peerid: e.uid + "",
                            ec: n,
                            subscribeRequestid: b.subscribeRequestId.get(t.getId()) || 0,
                            p2pid: b.p2ps.get(t.getId())
        ...
        1)
                    ...
                    for (; ; )
                        ...
                        case 0:
                            ...
                            e.abrupt("return", new Promise((function(e, t) {
                                ...
                                p.setRequestHeader("X-Packet-Service-Type", "0"),
                                p.setRequestHeader("X-Packet-URI", "61"),
                                p.onload = function() {
                                    if (!l) {
                                        var n = null
                                          , i = null;
                                        try {
                                            ...
                                            var a = "Invalid text ".concat(p.responseText);
                                        ...
                                        try {
                                            ...
                                            var s = "Invalid json_body ".concat(p.responseText);
                ...
                return $.a.wrap((function(e) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            d = t.proxyServer,
                            u = null,
                            e.t0 = $.a.keys(Object(r.getParameter)("UAP_AP"));
                        case 3:
                            if ((e.t1 = e.t0()).done) {
                                e.next = 34;
                                break
                            ...
                            return l = e.t1.value,
                            p = d ? "https://".concat(d, "/ap/?url=").concat(Object(r.getParameter)("UAP_AP")[l], "/api/v1&action=uap") : "https://".concat(Object(r.getParameter)("UAP_AP")[l], "/api/v1?action=uap"),
                            f = void 0,
                            e.prev = 7,
                            e.next = 10,
                            It({
                            ...
                            g = $.a.mark((function e(t) {
                                ...
                                return $.a.wrap((function(e) {
                                    for (; ; )
                                        ...
                                        case 0:
                                            if (i = f.servers[t],
                                            a = d ? "wss://".concat(d, "/ws/?h=").concat(i.address.replace(/\./g, "-"), ".edge.").concat(t % 2 == 0 ? "agora.io" : "agoraio.cn", "&p=").concat(i.wss, "&serviceName=").concat(encodeURIComponent(n)) : "wss://".concat(i.address.replace(/\./g, "-"), ".edge.").concat(t % 2 == 0 ? "agora.io" : "agoraio.cn", ":").concat(i.wss, "?serviceName=").concat(encodeURIComponent(n)),
                                            i.wss) {
                                                e.next = 5;
                                                break
                                            }
                        ...
                        case 20:
                            ...
                            return e.delegateYield(g(m), "t3", 22);
                        case 22:
                            v = e.t3,
                            e.t4 = v,
          ...
          , Ot = function(e) {
            ...
            s.disconnect = ee()($.a.mark((function e() {
                var t;
                return $.a.wrap((function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            for (t in s.status = ft,
                    ...
                    return $.a.wrap((function(e) {
                        for (; ; )
                            ...
                            case 5:
                                ...
                                new Error(i);
                            case 11:
                                if (s.status !== ft || t.clientRequest && "DestroyWorker" === t.clientRequest.command) {
                                    e.next = 17;
                                    break
                                }
            ...
            s._flush = function() {
                s.connection && s.status === mt && s.requests.forEach((function(e) {
            ...
            s.startPingpong = function() {
                clearInterval(s.pingpongTimer),
                s.pingpongTimer = setInterval(ee()($.a.mark((function e() {
                    return $.a.wrap((function(e) {
                        for (; ; )
                            switch (e.prev = e.next) {
                            case 0:
                                if (s.status !== mt || !s.connection || 1 !== s.connection.readyState) {
                                    e.next = 9;
                                    break
                                }
                                return e.prev = 1,
        ...
        var wt = function(e) {
          ...
          , Pt = function(e) {
            ...
            t.mode = e.mode,
            t.codec = e.codec,
            t.clientId = Object(G.generateSessionId)().slice(0, 5),
            t.uintUid = null,
            ...
            t.startChannelMediaRelay = function(n, i) {
                ...
                if (!(n instanceof Ce.ChannelMediaRelayConfiguration))
                ...
                if (o.forEach((function(e) {
                    ...
                    if (e.token && !Object(z.isValidToken)(e.token))
                        throw "Invalid token in destChannelMediaInfo"
                }
                )),
                t.gatewayClient.state !== ot.CONNECTED)
            ...
            t.setClientRole = function(n, i) {
                ...
                if (Object(z.checkValidEnum)(n, "setClientRole", [Mt, "audience"]),
                "rtc" === t.mode) {
                ...
                n === Mt && t.gatewayClient.setClientRole(Mt, a)) : (t.gatewayClient.role = n,
                a && a(null, {
                    role: n
                }))
            }
            ...
            t.setLowStreamParameter = function(n) {
                ...
                Object(z.checkValidObject)(n, "param");
                var a = n.width
                  , r = n.height
                  , c = n.framerate
                  , d = n.bitrate;
                Object(z.isEmpty)(a) || Object(z.checkValidNumber)(a, "width"),
                Object(z.isEmpty)(r) || Object(z.checkValidNumber)(r, "height"),
                Object(z.isEmpty)(c) || Object(z.checkValidNumber)(c, "framerate"),
                Object(z.isEmpty)(d) || Object(z.checkValidNumber)(d, "bitrate", 1, 1e7),
            ...
            t.init = function(n, i, a) {
                ...
                Object(z.checkValidString)(n),
                Object(g.isChromeKernel)() && Object(g.getChromeKernelVersion)() <= 48 ? a ? r(I.default.BAD_ENVIRONMENT) : Object(G.popBanTip)() : (o.default.info("[".concat(t.clientId, "] Initializing AgoraRTC client, appId: ").concat(n, ".")),
                e.appId = n,
                e.sessionId = Object(G.generateSessionId)(),
                r())
            }
            ,
            t.setTurnServer = function(n) {
                ...
                if (t.gatewayClient && t.gatewayClient.state !== ot.DISCONNECTED)
                ...
                var a = [];
                n.map((function(e, n) {
                    Object(z.checkValidObject)(e, "turnServer");
                    var i = e.turnServerURL
                      ...
                      , d = e.forceturn
                      , u = e.tcpport;
                    if (Object(z.checkValidString)(i, "turnServerURL"),
                    Object(z.checkValidString)(r, "username"),
                    Object(z.checkValidString)(s, "password"),
                    Object(z.checkValidString)(c, "udpport"),
                    0 === parseInt(c))
                        throw new Error("udpport should not be ".concat(c));
                    Object(z.isEmpty)(d) || Object(z.checkValidBoolean)(d, "forceturn");
                    var l = {
                        mode: "manual"
                    };
                    if (l.url = i,
                    ...
                    l.forceturn = d || !1,
                    !Object(z.isEmpty)(u)) {
                        if (Object(z.checkValidString)(u, "tcpport"),
                        0 === parseInt(u))
            ...
            t.setProxyServer = function(n) {
                ...
                if (t.useProxyServer)
                    throw new Error("You have already set the proxy");
                Object(z.checkValidString)(n, "proxyServer"),
                t.proxyServer = n,
            ...
            t.setEncryptionSecret = function(n) {
                ...
                Object(z.checkValidString)(n, "password"),
                t.aespassword = n,
                i()
            }
            ,
            t.setEncryptionMode = function(n) {
                ...
                if (Object(z.checkValidString)(n, "encryptionMode"),
                -1 === ke.indexOf(n))
            ...
            t.configPublisher = function(n) {
                ...
                Object(z.checkValidObject)(n, "config");
                var a = n.width
                  , r = n.height
                  , o = n.framerate
                  , c = n.bitrate
                  , d = n.publisherUrl;
                Object(z.checkValidNumber)(a, "width"),
                Object(z.checkValidNumber)(r, "height"),
                Object(z.checkValidNumber)(o, "framerate"),
                Object(z.checkValidNumber)(c, "bitrate", 1, 1e7),
                d && Object(z.checkValidString)(d, "publisherUrl"),
            ...
            t.join = function(n, i, a, r, c) {
                ...
                if ("string" == typeof i && "" === i)
                    ...
                    d(I.default.INVALID_PARAMETER);
                if (a && !Object(G.is32Uint)(a) && !Object(z.isValidString)(a, 1, 255))
                    return o.default.error("Invalid UID ".concat(a, " ").concat(Te()(a))),
                ...
                var u = Date.now()
                  , l = setTimeout((function() {
                    if (1 != t.gatewayClient.hasJoined) {
                        o.default.debug("[".concat(t.clientId, "] The time to join the channel is greater than 5 seconds "));
                        var n = Date.now();
                        s.b.joinChannelTimeOut({
                            lts: n,
                            sid: e.sessionId,
                            cname: i,
                            cid: t.joinInfo.cid,
                            uid: t.joinInfo.uid || ("string" == typeof a ? void 0 : a),
                            elapse: n - u,
                            timeout: 5
                        })
                    }
                ...
                if ("string" == typeof a && (p.stringUid = a,
                t.uintUid ? (p.uid = t.uintUid,
                delete t.uintUid) : p.uid = 0),
                t.aespassword && "none" !== t.aesmode && _()(p, {
                ...
                ,
                t.channel = i,
                t.gatewayClient.state !== ot.DISCONNECTED)
                ...
                var f = function(a, r) {
                    ...
                    p.apResponse = a.res,
                    a.uni_lbs_ip && a.uni_lbs_ip[1] && (p.uni_lbs_ip = a.uni_lbs_ip[1]),
                    p.gatewayAddr = a.gateway_addr,
                    t.joinInfo = p,
                    t.gatewayClient.join(p, t.key, (function(e) {
                ...
                p.stringUid && !p.uid ? (t.userAccountReq && !t.userAccountReq.isFinished() && t.userAccountReq.cancel(),
                t.userAccountReq = Xe(p, t.gatewayClient),
                t.userAccountReq.then((function(e) {
                    o.default.debug("getUserAccount Success ".concat(e.url, " ").concat(p.stringUid, " => ").concat(e.uid)),
                    p.uid = e.uid,
                    Ke(p, f, (function(e) {
                        return d(e)
                    }
            ...
            t.renewChannelKey = function(n, i, a) {
                ...
                Object(z.checkValidString)(n, "key", 1, 2047),
            ...
            t.leave = function(n, i) {
                t.gatewayClient.isFirstSuccess = !0,
                ...
                t.gatewayClient.state === ot.CONNECTING && (t.gatewayClient.state = ot.DISCONNECTED)),
            ...
            t._renewSession = function() {
                var n = Object(G.generateSessionId)();
            ...
            t._publish = function(n, i, a, s) {
                ...
                var c = function(n, i, a) {
                    t.gatewayClient.publish(n, {
                        ...
                        t.isDualStream ? t._publishLowStream((function() {
                            ...
                            o.default.warning("[".concat(t.clientId, "] "), e),
                            Ee.replaceWithCanvasTrack(n).then((function() {
                                i && i()
                            }
                            ))
                        }
                ...
                "audience" !== t.gatewayClient.role || "live" !== t.mode || s ? c(n, i, a) : t.gatewayClient.setClientRole(Mt, (function(e) {
                    if (e)
                        return a && a(e);
                    c(n, i, a)
                }
            ...
            t._unpublish = function(e, n, i, a) {
                ...
                t.gatewayClient.role !== Mt || "live" !== t.mode || a ? r(e, n, i) : t.gatewayClient.setClientRole("audience", (function(t) {
                    if (t)
                        return i && i(t);
                    r(e, n, i)
                }
            ...
            t.publish = function(n, i) {
                ...
                2 === t.highStreamState ? n._hasVideoTracks() || n._hasAudioTracks() ? (t.gatewayClient.publishRequestId = Object(G.generateId)(),
                t._publish(n, (function(e) {
                    return a(null, e)
                }
                ), (function(e) {
                    return a(e)
            ...
            t.unpublish = function(n, i, a) {
                ...
                0 === t.highStreamState ? (t.gatewayClient.publishRequestId = null,
                t._unpublish(n, (function(e) {
                    return r(null, e)
                }
                ), (function(e) {
                    return r(e)
            ...
            t.subscribe = function(n, i, a) {
                ...
                i = null),
                Object(z.checkValidObject)(n, "stream"),
                Object(z.isEmpty)(i) || (Object(z.checkValidObject)(i, "options"),
                Object(z.isEmpty)(i.video) || Object(z.checkValidBoolean)(i.video, "options.video"),
                Object(z.isEmpty)(i.audio) || Object(z.checkValidBoolean)(i.audio, "options.audio"));
                var c = {
                    video: !0,
                    audio: !0
                };
                if (!Object(z.isEmpty)(i)) {
                    ...
                    if (!Object(z.isEmpty)(i.video) && !Object(z.isValidBoolean)(i.video) || !Object(z.isEmpty)(i.audio) && !Object(z.isValidBoolean)(i.audio) || !1 === i.audio && !1 === i.video) {
                        d = "INVALID_PARAMETER ".concat(JSON.stringify(i));
                        return o.default.error("[".concat(t.clientId, "] "), d),
                        void r(d)
                    }
                }
                n.subscribeOptions ? (_()(n.subscribeOptions, c, i),
                t.gatewayClient.subscribeChange(n, (function(e) {
                    return r(null, e)
                }
                ), r)) : (t.gatewayClient.subscribeRequestId.set(n.getId(), Object(G.generateId)()),
                n.subscribeOptions = _()({}, c, i),
            ...
            t.unsubscribe = function(n, i) {
                ...
                t.gatewayClient.subscribeRequestId.delete(n.getId()),
            ...
            t.setRemoteVideoStreamType = function(n, i) {
                ...
                Object(z.checkValidEnum)(i, "streamType", [0, 1]),
            ...
            t.setStreamFallbackOption = function(n, i) {
                ...
                Object(z.checkValidEnum)(i, "fallbackType", [0, 1, 2]),
            ...
            t.enableAudioVolumeIndicator = function(n, i) {
                ...
                n = n || 2e3,
                i = i || 3,
                Object(z.checkValidNumber)(i, "smooth", 1, 100),
                Object(z.checkValidNumber)(n, "interval", 50, 1e5),
            ...
            ,
            t.sendCustomReportMessage = function(n, i, a, c, d, u) {
                Object(r.getParameter)("CR") ? t.customReportCount > Object(r.getParameter)("CRL") ? u && u("REPORT_LIMITED") : (t.gatewayClient.hasJoined || (o.default.WARNING("Should invoke Client.sendCustomReportMessage after join"),
                u && u("REPORT_BEFORE_JOINED")),
                t.customReportTimer || (t.customReportTimer = setInterval((function() {
                    t.customReportCount = 0
                }
                ), Object(r.getParameter)("CRI"))),
                Object(z.checkValidString)(n, "reportId", 0, 100, !1),
                Object(z.checkValidString)(i, "category", 0, 100, !1),
                Object(z.checkValidString)(a, "event", 0, 100, !1),
                Object(z.checkValidString)(c, "label", 0, 100, !1),
                Object(z.checkValidNumber)(d, "value", Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER),
                t.customReportCount++,
                s.b.sendCustomReportMessage(e.sessionId, {
                    reportId: n,
                    category: i,
                    event: a,
                    label: c,
            ...
            t.rtcStatsCollector = function(e) {
                ...
                t.getRemoteAudioStats = function(e) {
                    var n = t.gatewayClient.traffic_stats
                      , i = {};
                    for (var a in t.remoteStats) {
                        var r = {}
                          , o = t.remoteStats[a];
                        if (q(r, "End2EndDelay", o.peer_delay && o.peer_delay.audio_delay),
                        q(r, "TransportDelay", o.peer_delay && o.peer_delay.e2e_delay),
                        q(r, "PacketLossRate", o.peer_delay && o.peer_delay.e2e_audio_lost_ratio_400ms),
                        q(r, "RecvLevel", o.audioStats && o.audioStats.audioOutputLevel),
                        q(r, "RecvBitrate", o.audioRecvBitrate),
                        q(r, "CodecType", o.audioStats && o.audioStats.googCodecName),
                        q(r, "MuteState", o.audioDisabled),
                        q(r, "TotalFreezeTime", o.audioStats && o.audioStats.audioTotalFreezeTime),
                        q(r, "TotalPlayDuration", o.audioStats && o.audioStats.audioTotalPlayDuration),
                        n && n.peer_delay) {
                            ...
                            if (s) {
                                ...
                                q(r, "AudioPublishDuration", c)
                            } else
                                q(r, "AudioPublishDuration", -1)
                        }
                        i[a] = r
                    }
                    e && e(i)
                ...
                t.getLocalAudioStats = function(e) {
                    ...
                    for (var i in t.localStats) {
                        var a = {}
                          , r = t.localStats[i];
                        q(a, "RecordingLevel", r.audioStats && r.audioStats.audioInputLevel),
                        q(a, "SendLevel", r.audioStats && r.audioStats.totalAudioEnergy),
                        q(a, "SamplingRate", r.audioStats && r.audioStats.totalSamplesDuration),
                        q(a, "SendBitrate", r.audioSendBitrate),
                        q(a, "CodecType", r.audioStats && r.audioStats.googCodecName),
                        q(a, "MuteState", r.audioDisabled),
                        q(a, "audioSendPacketsLost", r.audioStats && r.audioStats.packetsLost);
                        var o = t.gatewayClient.localStreams[i];
                        o && o.isPlaying() && q(a, "MuteState", o.userMuteAudio ? "1" : "0"),
                        n[i] = a
                    }
                    e && e(n)
                }
                ...
                t.getRemoteVideoStats = function(e) {
                    ...
                    for (var a in t.remoteStats) {
                        var r = {}
                          , o = t.remoteStats[a];
                        if (q(r, "End2EndDelay", o.peer_delay && o.peer_delay.video_delay),
                        q(r, "TransportDelay", o.peer_delay && o.peer_delay.e2e_delay),
                        q(r, "PacketLossRate", o.peer_delay && o.peer_delay.e2e_video_lost_ratio_400ms),
                        q(r, "RecvBitrate", o.videoRecvBitrate),
                        q(r, "RecvResolutionWidth", o.videoStats && o.videoStats.googFrameWidthReceived),
                        q(r, "RecvResolutionHeight", o.videoStats && o.videoStats.googFrameHeightReceived),
                        q(r, "RenderResolutionWidth", o.videoStats && o.videoStats.renderRemoteWidth),
                        q(r, "RenderResolutionHeight", o.videoStats && o.videoStats.renderRemoteHeight),
                        q(r, "RenderFrameRate", o.videoStats && o.videoStats.googFrameRateOutput),
                        q(r, "MuteState", o.videoDisabled),
                        q(r, "TotalFreezeTime", o.videoStats && o.videoStats.videoTotalFreezeTime),
                        q(r, "TotalPlayDuration", o.videoStats && o.videoStats.videoTotalPlayDuration),
                        n && n.peer_delay) {
                            var s = n.peer_delay.find((function(e) {
                                return e.peer_uid == a
                            }
                            ...
                            if (s) {
                                ...
                                q(r, "VideoPublishDuration", c)
                            } else
                                q(r, "VideoPublishDuration", -1)
                        }
                        i[a] = r
                    }
                    e && e(i)
                ...
                t.getLocalVideoStats = function(e) {
                    ...
                    for (var i in t.localStats) {
                        var a = {}
                          , r = t.localStats[i];
                        q(a, "TargetSendBitrate", r.videoTargetSendBitrate),
                        q(a, "SendFrameRate", r.videoStats && r.videoStats.googFrameRateSent),
                        q(a, "SendBitrate", r.videoSendBitrate),
                        q(a, "SendResolutionWidth", r.videoStats && r.videoStats.googFrameWidthSent),
                        q(a, "SendResolutionHeight", r.videoStats && r.videoStats.googFrameHeightSent),
                        q(a, "CaptureResolutionWidth", r.videoStats && r.videoStats.googFrameWidthInput),
                        q(a, "CaptureResolutionHeight", r.videoStats && r.videoStats.googFrameHeightInput),
                        q(a, "EncodeDelay", r.videoStats && r.videoStats.googAvgEncodeMs),
                        q(a, "MuteState", r.videoDisabled),
                        q(a, "TotalFreezeTime", r.videoStats && r.videoStats.videoTotalFreezeTime),
                        q(a, "TotalDuration", r.videoStats && r.videoStats.videoTotalPlayDuration),
                        q(a, "CaptureFrameRate", r.videoStats && r.videoStats.googFrameRateSent),
                        q(a, "videoSendPacketsLost", r.videoStats && r.videoStats.packetsLost),
                        r.videoStats && !r.videoStats.googFrameWidthInput && q(a, "CaptureResolutionWidth", r.videoStats && r.videoStats.renderLocalWidth),
                        r.videoStats && !r.videoStats.googFrameHeightInput && q(a, "CaptureResolutionHeight", r.videoStats && r.videoStats.renderLocalHeight),
                        n[i] = a
                    }
                    e && e(n)
                }
                ...
                t.getRemoteVideoQualityStats = function(e) {
                    ...
                    for (var i in t.remoteStats) {
                        var a = {}
                          , r = t.remoteStats[i];
                        q(a, "videoReceiveDelay", r.videoStats && r.videoStats.googCurrentDelayMs),
                        q(a, "VideoFreezeRate", r.videoStats && r.videoStats.videoFreezeRate),
                        q(a, "FirstFrameTime", r.firstFrameTime),
                        n[i] = a
                    }
                    e && e(n)
                }
                ...
                t.getRemoteAudioQualityStats = function(e) {
                    ...
                    for (var i in t.remoteStats) {
                        var a = {}
                          , r = t.remoteStats[i];
                        q(a, "audioReceiveDelay", r.audioStats && r.audioStats.googCurrentDelayMs),
                        q(a, "AudioFreezeRate", r.videoStats && r.videoStats.videoFreezeRate),
                        n[i] = a
                    }
                    e && e(n)
                }
                ...
                t.getTransportStats = function(e) {
                    var n = {}
                      ...
                      , r = a.peer_delay;
                    if (q(n, "OutgoingAvailableBandwidth", t.gatewayClient.OutgoingAvailableBandwidth / 1e3),
                    q(n, "RTT", a && 2 * a.access_delay),
                    r) {
                        var o, s = ut(r);
                        try {
                            for (s.s(); !(o = s.n()).done; ) {
                                var c = o.value;
                                c.downlink_estimate_bandwidth && (i[c.peer_uid] = c.downlink_estimate_bandwidth / 1e3 + "")
                            }
                        } catch (e) {
                            s.e(e)
                        } finally {
                ...
                t.getSessionStats = function(e) {
                    ...
                    var d = r + t.session.WSSendBytesDelta + t.session.HTTPSendBytesDelta
                      ...
                      , l = t.session.sendBytes + Object(xe.getHTTPSendBytes)()
                      , p = t.session.recvBytes + Object(xe.getHTTPRecvBytes)();
                    t.gatewayClient.socket && t.gatewayClient.socket.state === t.gatewayClient.CONNECTED && (l += a.getSendBytes(),
                    p += a.getRecvBytes());
                    var f = 1;
                    i.peer_delay && (f = i.peer_delay.length,
                    f += 1),
                    q(n, "Duration", a.getDuration()),
                    q(n, "UserCount", f),
                    q(n, "SendBytes", l),
                    q(n, "RecvBytes", p),
                    q(n, "SendBitrate", 8 * d / 1e3),
                    q(n, "RecvBitrate", 8 * u / 1e3),
                    e && e(n)
                }
                ,
                ...
                t.getStatsTimer = setInterval((function() {
                    ...
                    Object.keys(t.gatewayClient.remoteStreams).forEach((function(a) {
                        ...
                        r.pc && "established" == r.pc.state && r.pc.getStats((function(e) {
                            ...
                            if (o && o.videoStats && s.videoStats) {
                                ...
                                if (s.videoStats.videoRecvBytesDelta = c,
                                t.session.recvBytes += c,
                                isFinite(c) && s.videoStats.timestamp) {
                                    a = s.videoStats.timestamp.getTime() - o.videoStats.timestamp.getTime();
                    ...
                    if (Object.keys(t.gatewayClient.localStreams).forEach((function(e) {
                        ...
                        i.pc && "established" == i.pc.state && i.pc.getStats((function(e) {
                            ...
                            if (o.videoStats && r && r.videoStats) {
                                ...
                                if (o.videoStats.videoSendBytesDelta = s,
                                t.session.sendBytes += s,
                                isFinite(s) && o.videoStats.timestamp) {
                                    a = o.videoStats.timestamp.getTime() - r.videoStats.timestamp.getTime();
                    ...
                    t.localStats = a,
                    t.session.HTTPSendBytesDelta = Object(xe.getHTTPSendBytes)() - t.session.HTTPSendBytes,
                    t.session.HTTPSendBytes = Object(xe.getHTTPSendBytes)(),
                    t.session.HTTPRecvBytesDelta = Object(xe.getHTTPRecvBytes)() - t.session.HTTPRecvBytes,
                    t.session.HTTPRecvBytes = Object(xe.getHTTPRecvBytes)(),
            ...
            t.configDistributManager = function(e) {
                ...
                t.client.gatewayClient && t.client.gatewayClient.on("config-distribute", (function(n) {
                    var i = n.joinInfo
                      , a = n.config;
                    if (a) {
                        Object(z.isEmpty)(a.uploadLog) || (Object(r.setParameter)("UPLOAD_LOG", a.uploadLog),
                        ...
                        Object(z.isEmpty)(a.dualStream) || (e.isDualStream = a.dualStream,
                        s.b.reportApiInvoke(i.sid, {
                            name: "_configDistribute",
                            options: {
                                feature: "dualStream",
                        ...
                        Object(z.isEmpty)(a.streamFallbackOption) || t.client.gatewayClient && t.client.gatewayClient.on("stream-subscribed", (function(e) {
                            var n = e.stream;
            ...
            function(e, t) {
                ...
                e.liveStreaming.connect = function() {
                    var n = ee()($.a.mark((function n(i) {
                        var a, r;
                        return $.a.wrap((function(n) {
                            for (; ; )
                                ...
                                case 0:
                                    ...
                                    throw "CLIENT_NOT_JOINED",
                                    new Error("CLIENT_NOT_JOINED");
                                case 3:
                                    return a = new Ot({
                                        appId: t.appId,
                                        cname: e.channel,
                                    ...
                                    n.next = 7,
                                    Tt({
                                        proxyServer: e.useProxyServer && e.joinInfo && e.joinInfo.proxyServer,
                                        appId: t.appId,
                                        cname: e.channel,
                                        serviceName: i,
                                        sid: t.sessionId,
                ...
                e.liveStreaming.disconnect = function() {
                    var t = ee()($.a.mark((function t(n) {
                        var i, a;
                        return $.a.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    t.t0 = $.a.keys(e.liveStreaming.connections);
                                case 1:
                                    if ((t.t1 = t.t0()).done) {
                                        t.next = 13;
                                        break
                ...
                e.liveStreaming.resumeStates = function() {
                    var t = ee()($.a.mark((function t(n) {
                        var i, a, r, s, c, d, u, l;
                        return $.a.wrap((function(t) {
                            for (; ; )
                                ...
                                case 5:
                                    ...
                                    break;
                                case 8:
                                    t.t2 = $.a.keys(e.liveStreaming.pushStates);
                                case 9:
                                    if ((t.t3 = t.t2()).done) {
                                        t.next = 37;
                                        break
                                ...
                                case 35:
                                    ...
                                    break;
                                case 37:
                                    t.t5 = $.a.keys(e.liveStreaming.pullStates);
                                case 38:
                                    if ((t.t6 = t.t5()).done) {
                                        t.next = 62;
                                        break
                ...
                e.startLiveStreaming = function(n, i) {
                    Object(z.isEmpty)(i) || Object(z.checkValidBoolean)(i, "transcodingEnabled"),
                    Object(z.checkValidString)(n, "url", 1, 1024);
                ...
                ,
                e._startLiveStreaming = function() {
                    var n = ee()($.a.mark((function n(i, a) {
                        var r, s, c, d;
                        return $.a.wrap((function(n) {
                            for (; ; )
                                switch (n.prev = n.next) {
                                case 0:
                                    ...
                                    _()(r.clientRequest, e.liveStreaming.startOptions, {
                                        ts: Date.now(),
                                        url: i,
                ...
                e.setLiveTranscoding = function(n, i) {
                    ...
                    Object(z.checkValidObject)(n, "transcoding");
                    var a = n
                      , r = a.width
                      , c = a.height
                      , d = a.videoBitrate
                    ...
                    Object(z.isEmpty)(r) || Object(z.checkValidNumber)(r, "width"),
                    Object(z.isEmpty)(c) || Object(z.checkValidNumber)(c, "height"),
                    Object(z.isEmpty)(d) || Object(z.checkValidNumber)(d, "videoBitrate", 1, 1e6),
                    Object(z.isEmpty)(u) || Object(z.checkValidNumber)(u, "videoFramerate"),
                    Object(z.isEmpty)(l) || Object(z.checkValidBoolean)(l, "lowLatency"),
                    Object(z.isEmpty)(p) || Object(z.checkValidEnum)(p, "audioSampleRate", [32e3, 44100, 48e3]),
                    Object(z.isEmpty)(f) || Object(z.checkValidNumber)(f, "audioBitrate", 1, 128),
                    Object(z.isEmpty)(g) || Object(z.checkValidEnum)(g, "audioChannels", [1, 2, 3, 4, 5]),
                    Object(z.isEmpty)(m) || Object(z.checkValidNumber)(m, "videoGop"),
                    Object(z.isEmpty)(S) || Object(z.checkValidEnum)(S, "videoCodecProfile", [66, 77, 100]),
                    Object(z.isEmpty)(_) || Object(z.checkValidNumber)(_, "userCount", 0, 17),
                    Object(z.isEmpty)(h) || Object(z.checkValidNumber)(h, "backgroundColor", 0, 16777215),
                    !Object(z.isEmpty)(E)) {
                        if (!Object(z.isArray)(E))
                        ...
                        E.map((function(e, t) {
                            if (!Object(z.isEmpty)(e.uid) && !Nt(e.uid) && !Object(z.isValidString)(e.uid, 1, 255))
                                throw new Error("[String uid] Length of the string: [1,255]. ASCII characters only. [Number uid] The value range is [0,10000]");
                            if (Object(z.isEmpty)(e.x) ? e.x = 0 : Object(z.checkValidNumber)(e.x, "transcodingUser[".concat(t, "].x"), 0, 1e4),
                            Object(z.isEmpty)(e.y) ? e.y = 0 : Object(z.checkValidNumber)(e.y, "transcodingUser[".concat(t, "].y"), 0, 1e4),
                            Object(z.isEmpty)(e.width) ? e.width = 640 : Object(z.checkValidNumber)(e.width, "transcodingUser[".concat(t, "].width"), 0, 1e4),
                            Object(z.isEmpty)(e.height) ? e.height = 360 : Object(z.checkValidNumber)(e.height, "transcodingUser[".concat(t, "].height"), 0, 1e4),
                            Object(z.isEmpty)(e.zOrder) ? e.zOrder = 0 : Object(z.checkValidNumber)(e.zOrder, "transcodingUser[".concat(t, "].zOrder"), 0, 100),
                            Object(z.isEmpty)(e.alpha))
                                e.alpha = 1;
                            else if (!(Object(z.isNumber)(e.alpha) && e.alpha <= 1 && e.alpha >= 0))
                                throw new Error("transcodingUser[${index}].alpha: The value range is [0, 1]")
                        }
                        ))
                    }
                    if (!Object(z.isEmpty)(v)) {
                        if (!Object(z.isArray)(v))
                            throw new Error("[images]: images should be Array");
                        v.map((function(e, t) {
                            if (Object(z.checkValidString)(e.url, "images[".concat(t, "].url"), 1, 1024),
                            Object(z.isEmpty)(e.x) ? e.x = 0 : Object(z.checkValidNumber)(e.x, "images[".concat(t, "].x"), 0, 1e4),
                            Object(z.isEmpty)(e.y) ? e.y = 0 : Object(z.checkValidNumber)(e.y, "images[".concat(t, "].y"), 0, 1e4),
                            Object(z.isEmpty)(e.width) ? e.width = 160 : Object(z.checkValidNumber)(e.width, "images[".concat(t, "].width"), 0, 1e4),
                            Object(z.isEmpty)(e.height) ? e.height = 160 : Object(z.checkValidNumber)(e.height, "images[".concat(t, "].height"), 0, 1e4),
                            Object(z.isEmpty)(e.zOrder) ? e.zOrder = 0 : Object(z.checkValidNumber)(e.zOrder, "images[".concat(t, "].zOrder"), 0, 100),
                            Object(z.isEmpty)(e.alpha))
                                e.alpha = 1;
                            else if (!(Object(z.isNumber)(e.alpha) && e.alpha <= 1 && e.alpha >= 0))
                    ...
                    e.joinInfo.stringUid && n.userConfigs && n.userConfigs.length) {
                        ...
                        n.userConfigs.forEach((function(t) {
                            T.push(Xe(e.joinInfo, e.gatewayClient, t.uid).then((function(e) {
                                t.uid = e.uid
                            }
                            )))
                        }
                ...
                ,
                e._setLiveTranscoding = function() {
                    var t = ee()($.a.mark((function t(n, i) {
                        var a, r, o;
                        return $.a.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    if (e.liveStreaming.transcodingConfig = _()(e.liveStreaming.transcodingConfig, n),
                ...
                ,
                e._stopLiveStreaming = function() {
                    var t = ee()($.a.mark((function t(n, i, a) {
                        var r, o, s, c, d, u;
                        return $.a.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                ...
                e.addInjectStreamUrl = function(i, a) {
                    Object(z.checkValidString)(i, "url", 1, 1024),
                    Object(z.checkValidObject)(a, "config"),
                    !Object(z.isEmpty)(a && a.width) && Object(z.checkValidNumber)(a.width, "config.width", 0, 1e4),
                    !Object(z.isEmpty)(a && a.height) && Object(z.checkValidNumber)(a.height, "config.height", 0, 1e4),
                    !Object(z.isEmpty)(a && a.videoGop) && Object(z.checkValidNumber)(a.videoGop, "config.videoGop", 1, 1e4),
                    !Object(z.isEmpty)(a && a.videoFramerate) && Object(z.checkValidNumber)(a.videoFramerate, "config.videoFramerate", 1, 1e4),
                    !Object(z.isEmpty)(a && a.videoBitrate) && Object(z.checkValidNumber)(a.videoBitrate, "config.videoBitrate", 1, 1e4),
                    !Object(z.isEmpty)(a && a.audioSampleRate) && Object(z.checkValidEnum)(a.audioSampleRate, "config.audioSampleRate", [32e3, 44100, 48e3]),
                    !Object(z.isEmpty)(a && a.audioBitrate) && Object(z.checkValidNumber)(a.audioBitrate, "config.audioBitrate", 1, 1e4),
                    !Object(z.isEmpty)(a && a.audioChannels) && Object(z.checkValidNumber)(a.audioChannels, "config.audioChannels", 1, 2);
                ...
                ,
                e._addInjectStreamUrl = function() {
                    var n = ee()($.a.mark((function n(i, a) {
                        var r, o, s, c, d;
                        return $.a.wrap((function(n) {
                            for (; ; )
                                switch (n.prev = n.next) {
                                case 0:
                                    return r = _()({}, e.liveStreaming.injectStreamTranscodingConfig, a),
                                    o = {
                                        allocate: !0,
                                        clientRequest: {
                                            cname: e.channel,
                ...
                e.removeInjectStreamUrl = function() {
                    var n = ee()($.a.mark((function n(i) {
                        var a, r, o = arguments;
                        return $.a.wrap((function(n) {
                            for (; ; )
                                switch (n.prev = n.next) {
                                case 0:
                                    return Object(z.checkValidString)(i, "url", 1, 255),
                ...
                e._removeInjectStreamUrl = function() {
                    var t = ee()($.a.mark((function t(n) {
                        var i, a, r, o;
                        return $.a.wrap((function(t) {
                            for (; ; )
            ...
            Object(z.isEmpty)(e.turnServer) || t.setTurnServer(e.turnServer),
            Object(z.isEmpty)(e.proxyServer) || t.setProxyServer(e.proxyServer),
            "live" === t.mode && (t.gatewayClient.role = "audience"),
            "rtc" === t.mode && (t.gatewayClient.role = Mt),
            t.gatewayClient.on("onMultiIP", (function(e) {
                ...
                var n = function(e) {
                    ...
                    ), t.onFailure) : (t.gatewayClient.joinInfo = _()({}, t.joinInfo),
                ...
                t.userAccountReq = Xe(joinInfo, t.gatewayClient),
                t.userAccountReq.then((function(e) {
            ...
            pt.on("networkTypeChanged", (function(e) {
          ...
          , Vt = function(e) {
            return -1 === we.indexOf(e.mode) ? I.default.INVALID_CLIENT_MODE : -1 === De.indexOf(e.codec) ? I.default.INVALID_CLIENT_CODEC : "h264_interop" == e.mode && "h264" !== e.codec && I.default.CLIENT_MODE_CODEC_MISMATCH
        }
          , jt = function(e) {
            switch (e.mode) {
            case "interop":
        ...
        n.default = {
            ...
            createStream: function(e) {
                ...
                Object(z.checkValidObject)(e, "StreamSpec");
                var n = e.streamID
                  , i = e.audio
                  , a = e.video
                  , r = e.screen
                ...
                e.cameraId)
                  ...
                  , g = e.mediaSource
                  , m = e.audioProcessing;
                if (!Object(z.isEmpty)(n) && !Object(G.is32Uint)(n) && !Object(z.isValidString)(n, 1, 255))
                ...
                if (Object(z.checkValidBoolean)(i, "audio"),
                Object(z.checkValidBoolean)(a, "video"),
                Object(z.isEmpty)(r) || Object(z.checkValidBoolean)(r, "screen"),
                Object(z.isEmpty)(c) || Object(z.checkValidBoolean)(c, "screenAudio"),
                Object(z.isEmpty)(d) || Object(z.checkValidString)(d, "cameraId", 0, 255, !1),
                Object(z.isEmpty)(u) || Object(z.checkValidEnum)(u, "facingMode", ["user", "environment", "left", "right"]),
                Object(z.isEmpty)(l) || Object(z.checkValidString)(l, "microphoneId", 0, 255, !1),
                Object(z.isEmpty)(f) || Object(z.checkValidString)(f, "extensionId"),
                Object(z.isEmpty)(g) || Object(z.checkValidEnum)(g, "mediaSource", ["screen", "application", "window"]),
                Object(z.isEmpty)(p) || Object(z.checkValidBoolean)(p, "mirror"),
                !Object(z.isEmpty)(m)) {
                    var v = m.AGC
                      , S = m.AEC
                      , _ = m.ANS;
                    Object(z.isEmpty)(v) || Object(z.checkValidBoolean)(v, "AGC"),
                    Object(z.isEmpty)(S) || Object(z.checkValidBoolean)(S, "AEC"),
                    Object(z.isEmpty)(_) || Object(z.checkValidBoolean)(_, "ANS")
                }
            ...
            getSupportedCodec: Oe.getSupportedCodec,
            ChannelMediaRelayConfiguration: Ce.ChannelMediaRelayConfiguration,
            VERSION: r.VERSION,
            BUILD: r.BUILD,
            PROFILE_TABLE: Wt,
